        ...
        <div className="relative z-10 w-1/2 flex-shrink-0 flex flex-col justify-between px-14 py-12">
          ...
          >
            ...
            >
              ...
              Gêmeo Digital · DRM · Proposta 2025
            </div>
          </motion.div>
          ...
          <div className="flex flex-col gap-5">
            ...
            >
              Infraestrutura de dados em tempo real, simulação urbana e inteligência preditiva para a maior metrópole da América Latina.
            </motion.p>
          </div>
          ...
          >
            <span className="text-white/20 text-[10px] font-mono tracking-widest uppercase">Powered by</span>
        ...
        <div className="relative z-10 flex-1 flex flex-col items-center justify-center gap-8 px-14">
          ...
          >
            ...
            <p className="text-white/50 text-sm font-light tracking-wide">
              Um projeto da Cidade de São Paulo
            </p>
          </motion.div>
        </div>
