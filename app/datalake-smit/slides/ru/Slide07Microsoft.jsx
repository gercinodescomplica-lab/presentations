...
const pillars = [
  { icon: '📄', title: 'Контракт через PRODAM', desc: 'Префектура заключает контракт через PRODAM — муниципальную государственную компанию, которая управляет коммерческими и техническими отношениями с Microsoft.' },
      ...
      >
        ...
        <div className="relative z-10 w-[42%] flex flex-col justify-center px-12 lg:px-14 py-14 gap-6 border-r"
          ...
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} whileHover={{ scale: 1.015, boxShadow: '0 4px 20px rgba(47,128,255,0.10)', transition: { duration: 0.22, ease: [0.22, 1, 0.36, 1] } }} transition={{ delay: 0.8 }}
            ...
            Коммерческое соглашение структурировано через PRODAM как контрактного управляющего — обеспечивая полный контроль, прозрачность и выгодные условия при сохранении чёткой цепочки ответственности.
          </motion.p>
