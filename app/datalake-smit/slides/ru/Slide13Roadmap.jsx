...
const phases = [
  ...
  },
  {
    ...
    items: [
      'SAC интегрирован в озеро данных',
      'Descomplica SP подключён',
      'Первые операционные дашборды',
  ...
  },
  {
    ...
    items: [
      ...
      'Открытые API для партнёров',
      'ИИ-ассистент для менеджеров SMIT',
    ],
  },
]
    ...
    <div className="w-full h-full flex items-center justify-center p-6 lg:p-10">
      ...
      >
        ...
        <div className="absolute top-6 right-8 z-20">
          <span className="text-xs font-mono tracking-widest" style={{ color: 'rgba(47,128,255,0.5)' }}>13 · ДОРОЖНАЯ КАРТА</span>
        </div>
      </motion.div>
    </div>
  )
