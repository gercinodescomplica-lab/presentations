...
const phases = [
  ...
  {
    number: '02',
    title: 'Primeros Datos',
    period: 'Q4 2026',
    color: BLUE,
    status: 'PLANIFICADO',
    items: [
      'SAC integrado al data lake',
      'Descomplica SP conectado',
  ...
  },
  {
    ...
    status: 'HOJA DE RUTA',
    items: [
      'Agendamento SMIT integrado',
      'Analítica en tiempo real',
      'Reportes de gestión automatizados',
      'Auditoría ANPD completada',
    ],
  },
  {
    number: '04',
    ...
    items: [
      ...
      'APIs abiertas para socios gov',
      'IA asistiendo gestores SMIT',
    ],
  },
]
    ...
    <div className="w-full h-full flex items-center justify-center p-6 lg:p-10">
      ...
      >
        ...
        <div className="relative z-10 flex items-center justify-between px-12 pt-8 pb-5 border-b"
          ...
          <div>
            ...
            <motion.h2 initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} whileHover={{ scale: 1.015, y: -4, boxShadow: '0 8px 32px rgba(47,128,255,0.18), 0 0 0 1px rgba(47,128,255,0.12)', transition: { duration: 0.22, ease: [0.22, 1, 0.36, 1] } }} transition={{ delay: 0.35 }}
              ...
              De la fundación a la inteligencia SMIT
            </motion.h2>
          </div>
        </div>
        ...
        <div className="absolute top-6 right-8 z-20">
          <span className="text-xs font-mono tracking-widest" style={{ color: 'rgba(47,128,255,0.5)' }}>13 · HOJA DE RUTA</span>
        </div>
      </motion.div>
    </div>
  )
