...
const pillars = [
  { icon: '📄', title: 'Contrato vía PRODAM', desc: 'La Prefectura contrata a través de PRODAM — empresa pública municipal que gestiona la relación comercial y técnica con Microsoft.' },
      ...
      >
        ...
        <div className="relative z-10 w-[42%] flex flex-col justify-center px-12 lg:px-14 py-14 gap-6 border-r"
          ...
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} whileHover={{ scale: 1.015, boxShadow: '0 4px 20px rgba(47,128,255,0.10)', transition: { duration: 0.22, ease: [0.22, 1, 0.36, 1] } }} transition={{ delay: 0.8 }}
            ...
            El acuerdo comercial se estructura a través de PRODAM — empresa pública municipal que gestiona la relación con Microsoft, garantizando control institucional, transparencia y condiciones favorables a la escala de una alianza con una ciudad global.
          </motion.p>
