...
const systems = [
  { icon: '📞', name: 'SAC', desc: 'Sistema de atención al ciudadano — solicitudes y servicios municipales', tag: 'Atención' },
  { icon: '🎓', name: 'Descomplica SP', desc: 'Plataforma de simplificación de trámites digitales', tag: 'Gobierno Digital' },
  { icon: '📅', name: 'Agendamento SMIT', desc: 'Agenda municipal y seguimiento de asistencia', tag: 'Operaciones' },
  { icon: '📋', name: 'Novo 156 – CRM', desc: 'Gestión de solicitudes ciudadanas y plataforma de relación', tag: 'CRM' },
