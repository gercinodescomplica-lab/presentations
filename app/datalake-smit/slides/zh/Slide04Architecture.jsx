...
const agencies = [
  ...
  { name: 'SME', systems: ['入学登记', '教育门户', 'CMSP'], angle: -30, color: BLUE_DARK },
  { name: 'SMS', systems: ['eSUS', '疫苗接种', '数字UBS'], angle: 30, color: GREEN },
  { name: 'SMADS', systems: ['CRAS', 'CREAS', '社会福利'], angle: 90, color: PURPLE },
  { name: 'SMSUB', systems: ['区政府', '市政维护', '工程'], angle: 150, color: AMBER },
    ...
    <div className="w-full h-full flex items-center justify-center p-4 lg:p-6"
      ...
      >
        ...
        <div className="relative z-10 px-10 pt-8 pb-4 flex-shrink-0">
          ...
          >
            <span className="text-xs font-mono font-semibold tracking-widest" style={{ color: BLUE }}>可扩展模型</span>
          </motion.div>
          <motion.h2
        ...
        <div className="relative flex-1 flex items-center justify-center px-6 pb-6 min-h-0">
            ...
            <div className="absolute z-20"
              ...
              >
                <div className="flex flex-col items-center justify-center rounded-2xl text-center px-4 py-3"
                  ...
                  <span className="text-white text-[10px] font-mono tracking-wider leading-tight font-bold">数据湖</span>
                  <span className="text-white/80 text-[9px] font-mono tracking-wide leading-tight mt-0.5">保利斯塔诺</span>
                  <div className="mt-1.5 flex items-center gap-1">
                    <span className="w-1.5 h-1.5 rounded-full bg-white/90 animate-pulse" />
                    <span className="text-white/70 text-[8px] font-mono">试点活跃 (SMIT)</span>
                  </div>
                </div>
              </motion.div>
            </div>
                    ...
                    >
                      ...
                      {isActive && (
                        <div className="flex items-center gap-1 mt-0.5">
                          ...
                          <span className="text-[8px] font-mono" style={{ color: BLUE }}>活跃</span>
                        </div>
                      )}
                    </div>
                  </motion.div>
          ...
          >
            <span className="text-[9px] font-mono tracking-widest mb-0.5" style={{ color: 'rgba(47,128,255,0.5)' }}>图例</span>
            <div className="flex items-center gap-2">
              <div className="w-6 h-px" style={{ background: BLUE }} />
              <span className="text-[9px]" style={{ color: '#6B84B8' }}>秘书处数据湖</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-6 h-px border-t border-dashed" style={{ borderColor: '#9CA3AF' }} />
              <span className="text-[9px]" style={{ color: '#6B84B8' }}>未来集成</span>
            </div>
          </motion.div>
        </div>
      </motion.div>
