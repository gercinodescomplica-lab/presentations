...
const agencies = [
  ...
  { name: 'SMS', systems: ['eSUS', 'Vacinas', 'UBS Digital'], angle: 30, color: GREEN },
  { name: 'SMADS', systems: ['CRAS', 'CREAS', 'Benefícios'], angle: 90, color: PURPLE },
    ...
    <div className="w-full h-full flex items-center justify-center p-4 lg:p-6"
      ...
      >
        ...
        <div className="relative z-10 px-10 pt-8 pb-4 flex-shrink-0">
          ...
          >
            <span className="text-xs font-mono font-semibold tracking-widest" style={{ color: BLUE }}>MODELO ESCALÁVEL</span>
          </motion.div>
          <motion.h2
        ...
        <div className="relative flex-1 flex items-center justify-center px-6 pb-6 min-h-0">
              ...
              >
                <div className="flex flex-col items-center justify-center rounded-2xl text-center px-4 py-3"
                  ...
                  <div className="mt-1.5 flex items-center gap-1">
                    ...
                    <span className="text-white/70 text-[8px] font-mono">Piloto Ativo (SMIT)</span>
                  </div>
                </div>
              </motion.div>
            </div>
                    ...
                    >
                      ...
                      {isActive && (
                        <div className="flex items-center gap-1 mt-0.5">
                          ...
                          <span className="text-[8px] font-mono" style={{ color: BLUE }}>Ativo</span>
                        </div>
                      )}
                    </div>
                  </motion.div>
          ...
          >
            <span className="text-[9px] font-mono tracking-widest mb-0.5" style={{ color: 'rgba(47,128,255,0.5)' }}>LEGENDA</span>
            <div className="flex items-center gap-2">
              <div className="w-6 h-px" style={{ background: BLUE }} />
              <span className="text-[9px]" style={{ color: '#6B84B8' }}>Data Lake da Secretaria</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-6 h-px border-t border-dashed" style={{ borderColor: '#9CA3AF' }} />
              <span className="text-[9px]" style={{ color: '#6B84B8' }}>Integração Futura</span>
            </div>
          </motion.div>
        </div>
      </motion.div>
