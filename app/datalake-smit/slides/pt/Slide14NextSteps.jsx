...
const actions = [
  { number: '01', title: 'Aprovar escopo do piloto', desc: 'Definir formalmente o perímetro do data lake SMIT — sistemas, tipos de dados e cronograma da Fase 1.', owner: 'SMIT + PRODAM', color: BLUE },
  { number: '02', title: 'Assinar MOU com a Microsoft', desc: 'Formalizar a intenção de parceria com um Memorando de Entendimento para liberar recursos de planejamento conjunto.', owner: 'PRODAM + Microsoft', color: BLUE_DARK },
  ...
  { number: '04', title: 'Revisão dos instrumentos jurídicos', desc: 'Jurídico da SMIT e Compliance da PRODAM revisam e assinam os acordos de tratamento de dados conformes à LGPD.', owner: 'Equipes Jurídicas', color: BLUE },
]
  ...
  return (
    <div className="w-full h-full flex items-center justify-center p-6 lg:p-10">
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none"
          style={{ background: 'radial-gradient(ellipse at 70% 50%, rgba(47,128,255,0.04) 0%, transparent 60%)' }} />
        ...
        <div className="relative z-10 w-[40%] flex flex-col justify-between px-12 lg:px-14 py-14 border-r"
          ...
          <div className="flex flex-col gap-6">
            <motion.h2 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} whileHover={{ scale: 1.015, y: -4, boxShadow: '0 8px 32px rgba(47,128,255,0.18), 0 0 0 1px rgba(47,128,255,0.12)', transition: { duration: 0.22, ease: [0.22, 1, 0.36, 1] } }} transition={{ delay: 0.35, duration: 0.8 }}
              ...
              style={{ fontSize: 'clamp(2.2rem, 4vw, 3rem)', background: `linear-gradient(135deg, #0D1B3E 0%, ${BLUE} 55%, ${BLUE_DARK} 100%)`, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
          ...
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} whileHover={{ scale: 1.015, y: -4, boxShadow: '0 8px 32px rgba(47,128,255,0.18), 0 0 0 1px rgba(47,128,255,0.12)', transition: { duration: 0.22, ease: [0.22, 1, 0.36, 1] } }} transition={{ delay: 1.3 }}
            ...
            <div className="flex items-center gap-2 pt-1" style={{ borderTop: `1px solid ${GREEN}15` }}>
              <span className="text-xs font-mono" style={{ color: '#7B93C4' }}>PRODAM · SMIT · MICROSOFT</span>
            </div>
          </motion.div>
        </div>
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-center px-10 lg:px-12 py-14 gap-4">
          {actions.map((a, i) => (
            <motion.div key={a.number}
              ...
              style={{ background: 'rgba(47,128,255,0.04)', border: `1px solid ${a.color}18` }}>
              ...
              <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0 font-heading font-bold"
                style={{ background: `${a.color}10`, border: `1px solid ${a.color}20`, color: a.color, fontSize: '1rem' }}>
                {a.number}
              </div>
        ...
        <div className="absolute top-6 right-8 z-20">
          <span className="text-xs font-mono tracking-widest" style={{ color: 'rgba(47,128,255,0.5)' }}>14 · PRÓXIMOS PASSOS</span>
        </div>
      </motion.div>
    </div>
  )
