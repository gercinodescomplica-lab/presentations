    ...
    <div className="w-full h-full flex items-center justify-center p-6 lg:p-10">
      ...
      >
          ...
          {principles.map((p, i) => (
            <motion.div key={p.title}
              ...
              <div className="absolute bottom-0 left-0 right-0 h-20 pointer-events-none"
                style={{ background: `radial-gradient(ellipse at 50% 100%, ${p.color}04 0%, transparent 70%)` }} />
        ...
        <div className="absolute top-6 right-8 z-20">
          <span className="text-xs font-mono tracking-widest" style={{ color: 'rgba(47,128,255,0.5)' }}>11 · SEGURANÇA</span>
        </div>
      </motion.div>
    </div>
  )
