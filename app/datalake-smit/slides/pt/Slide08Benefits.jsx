...
const benefits = [
  { icon: '📉', color: GREEN, title: 'Redução de Custos', headline: 'TCO até 40% menor', desc: 'O patrocínio Microsoft inclui créditos Azure com desconto, eliminando custos de infraestrutura e habilitando um modelo de crescimento gradual.', tags: ['Créditos Azure', 'Infra Elástica', 'Sem Capex'] },
  { icon: '⚡', color: BLUE, title: 'Implantação Acelerada', headline: '3× mais rápido', desc: 'Templates prontos para governo, arquiteturas comprovadas em 50+ cidades e engenheiros Microsoft FastTrack dedicados desde o início.', tags: ['FastTrack', 'Templates Gov', 'Jump-start'] },
  { icon: '🛠️', color: CYAN, title: 'Suporte Técnico', headline: 'Equipe dedicada', desc: 'A Microsoft designa um City Partner Team — arquitetos residentes, engenheiros de dados e especialistas em segurança — disponíveis durante toda a implementação.', tags: ['Suporte In-loco', 'SLA Garantido', '24/7'] },
  { icon: '🌍', color: AMBER, title: 'Expertise Global', headline: 'Experiência em escala municipal', desc: 'Aproveite lições de Helsinque, Cingapura e Nova York — cidades que construíram infraestrutura de dados inteligentes com Azure — adaptadas ao contexto regulatório brasileiro.', tags: ['Boas Práticas', 'Casos Gov', 'Refs Globais'] },
]
    ...
    <div className="w-full h-full flex items-center justify-center p-6 lg:p-10">
      ...
      >
        ...
        <div className="relative z-10 flex items-center justify-between px-12 pt-8 pb-5 border-b"
          ...
          <div>
            ...
            <motion.h2 initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} whileHover={{ scale: 1.015, y: -4, boxShadow: '0 8px 32px rgba(47,128,255,0.18), 0 0 0 1px rgba(47,128,255,0.12)', transition: { duration: 0.22, ease: [0.22, 1, 0.36, 1] } }} transition={{ delay: 0.35 }}
              className="font-heading font-bold" style={{ fontSize: '1.9rem', color: '#0D1B3E' }}>
              O que a Microsoft traz para o projeto
            </motion.h2>
          </div>
        </div>
          ...
          {benefits.map((b, i) => (
            <motion.div key={b.title}
              ...
              <div className="absolute bottom-0 left-0 right-0 w-full h-32 pointer-events-none"
                style={{ background: `radial-gradient(ellipse at 50% 100%, ${b.color}04 0%, transparent 70%)` }} />
              ...
              <div>
                ...
                <div className="font-heading font-bold leading-tight mb-2" style={{ fontSize: '1.1rem', color: '#0D1B3E' }}>{b.headline}</div>
        ...
        <div className="absolute top-6 right-8 z-20">
          <span className="text-xs font-mono tracking-widest" style={{ color: 'rgba(47,128,255,0.5)' }}>08 · BENEFÍCIOS</span>
        </div>
      </motion.div>
    </div>
  )
