      ...
      >
        ...
        <div className="relative z-10 flex-1 flex items-center justify-center">
          ...
          <motion.div
            ...
            <span className="text-[10px] font-mono font-bold tracking-widest" style={{ color: 'rgba(255,255,255,0.4)' }}>图例</span>
            {[
              { color: BLUE, label: '机构数据湖' },
              { color: CYAN, label: '试点运行中' },
              { color: 'rgba(255,255,255,0.2)', label: '未来集成' },
            ].map(item => (
        ...
        <div className="absolute top-6 right-8 z-20">
          <span className="text-xs font-mono tracking-widest" style={{ color: 'rgba(255,255,255,0.3)' }}>04 · 架构</span>
        </div>
      </motion.div>
    </div>
  )
