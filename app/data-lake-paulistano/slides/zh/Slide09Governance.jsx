    ...
    <div className="w-full h-full flex items-center justify-center p-6 lg:p-10">
      ...
      >
          ...
          {committees.map((c, i) => (
            <motion.div key={c.name}
              ...
              <div className="flex flex-col gap-2 mt-auto">
                <div className="text-[10px] font-mono font-bold tracking-widest mb-1" style={{ color: 'rgba(255,255,255,0.3)' }}>成员</div>
                {c.members.map(m => (
        ...
        <div className="absolute top-6 right-8 z-20">
          <span className="text-xs font-mono tracking-widest" style={{ color: 'rgba(255,255,255,0.3)' }}>09 · 治理</span>
        </div>
      </motion.div>
    </div>
  )
