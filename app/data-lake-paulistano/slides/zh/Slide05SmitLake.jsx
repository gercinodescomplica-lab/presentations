...
const systems = [
  { icon: '📞', name: '156', desc: '市民服务请求与投诉门户', tag: '核心服务' },
  { icon: '🎓', name: 'Descomplica SP', desc: '数字服务简化平台', tag: '数字政务' },
  { icon: '📅', name: '预约系统', desc: '市政预约与出勤追踪', tag: '运营管理' },
  { icon: '🪪', name: '数字身份', desc: '156统一身份平台', tag: '身份认证' },
    ...
    <div className="w-full h-full flex items-center justify-center p-6 lg:p-10">
      ...
      >
        ...
        <div className="absolute top-6 right-8 z-20">
          <span className="text-xs font-mono tracking-widest" style={{ color: 'rgba(255,255,255,0.3)' }}>05 · SMIT数据湖</span>
        </div>
      </motion.div>
    </div>
  )
