...
const pillars = [
  { icon: '📄', title: '直接合同', desc: '圣保罗市直接与微软签约 — 无中间商加价。' },
      ...
      >
        ...
        <div className="relative z-10 w-[42%] flex flex-col justify-center px-12 lg:px-14 py-14 gap-6 border-r"
          ...
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.8 }}
            ...
            商业协议将结构化为市政府与微软之间的直接合同 — 确保在全球城市合作伙伴关系规模下实现完全掌控、透明度和优惠条款。
          </motion.p>
        ...
        <div className="absolute top-6 right-8 z-20">
          <span className="text-xs font-mono tracking-widest" style={{ color: 'rgba(255,255,255,0.3)' }}>07 · 微软</span>
        </div>
      </motion.div>
    </div>
  )
