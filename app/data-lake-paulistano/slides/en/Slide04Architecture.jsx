      ...
      >
        ...
        <div className="relative z-10 flex-1 flex items-center justify-center">
          ...
          <motion.div
            ...
            <span className="text-[10px] font-mono font-bold tracking-widest" style={{ color: 'rgba(255,255,255,0.4)' }}>LEGEND</span>
            {[
              { color: BLUE, label: 'Agency Data Lake' },
              { color: CYAN, label: 'Active Pilot' },
              { color: 'rgba(255,255,255,0.2)', label: 'Future Integration' },
            ].map(item => (
        ...
        <div className="absolute top-6 right-8 z-20">
          <span className="text-xs font-mono tracking-widest" style={{ color: 'rgba(255,255,255,0.3)' }}>04 · ARCHITECTURE</span>
        </div>
      </motion.div>
    </div>
  )
