...
const phases = [
  ...
  },
  {
    ...
    status: 'PLANNED',
    items: [
      'SME and SMS data lakes',
      'Cross-agency citizen ID link',
  ...
  },
  {
    ...
    items: [
      ...
      'Citizen 360° view pilot',
      'ANPD compliance audit',
    ],
  },
  {
    number: '04',
    ...
    status: 'VISION',
    items: [
      'All 30+ agencies on network',
      'Real-time city intelligence',
      'Open data portal (curated)',
        ...
        <div className="relative z-10 flex items-center justify-between px-12 pt-8 pb-5 border-b"
          ...
          <div>
            ...
            <motion.h2 initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.35 }}
              ...
              From SMIT pilot to city-wide intelligence
            </motion.h2>
          </div>
        </div>
