...
const pillars = [
  { icon: '📄', title: 'Direct Contract', desc: 'City of São Paulo signs directly with Microsoft — no intermediary vendor markups.' },
      ...
      >
        ...
        <div className="relative z-10 w-[42%] flex flex-col justify-center px-12 lg:px-14 py-14 gap-6 border-r"
          ...
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.8 }}
            ...
            The commercial agreement would be structured as a direct contract between the City and Microsoft — ensuring full control, transparency, and favorable terms at the scale of a global city partnership.
          </motion.p>
