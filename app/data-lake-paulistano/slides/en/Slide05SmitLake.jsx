...
const systems = [
  { icon: '📞', name: '156', desc: 'Citizen service requests & complaints portal', tag: 'Core Service' },
  { icon: '🎓', name: 'Descomplica SP', desc: 'Digital service simplification platform', tag: 'Digital Gov' },
  { icon: '📅', name: 'Appointment System', desc: 'Municipal scheduling and attendance tracking', tag: 'Operations' },
  { icon: '🪪', name: 'Digital Identity', desc: '156 unified identity platform', tag: 'Identity' },
