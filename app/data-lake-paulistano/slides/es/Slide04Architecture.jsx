      ...
      >
        ...
        <div className="relative z-10 flex items-center justify-between px-12 pt-8 pb-4 border-b"
          ...
          <div className="flex flex-col gap-1">
            ...
            <motion.h2 initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.35 }}
              ...
              Data Lakes Federados — Ciudad Conectada
            </motion.h2>
          </div>
        ...
        <div className="relative z-10 flex-1 flex items-center justify-center">
          ...
          <motion.div
            ...
            <span className="text-[10px] font-mono font-bold tracking-widest" style={{ color: 'rgba(255,255,255,0.4)' }}>LEYENDA</span>
            {[
              { color: BLUE, label: 'Data Lake de Secretaría' },
              { color: CYAN, label: 'Piloto Activo' },
              { color: 'rgba(255,255,255,0.2)', label: 'Integración Futura' },
            ].map(item => (
        ...
        <div className="absolute top-6 right-8 z-20">
          <span className="text-xs font-mono tracking-widest" style={{ color: 'rgba(255,255,255,0.3)' }}>04 · ARQUITECTURA</span>
        </div>
      </motion.div>
    </div>
  )
