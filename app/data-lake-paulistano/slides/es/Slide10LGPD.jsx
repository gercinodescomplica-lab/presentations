...
const instruments = [
  { icon: '📋', title: 'Acuerdo de Tratamiento de Datos', desc: 'DPA formal entre la Ciudad, PRODAM y Microsoft — definiendo claramente los roles de controlador y procesadores de datos.', color: BLUE },
  { icon: '🔐', title: 'Cláusula de Limitación de Finalidad', desc: 'Restricciones legalmente vinculantes sobre el uso de los datos replicados — solo analítica, sin reventa comercial.', color: CYAN },
  { icon: '📢', title: 'Aviso y Consentimiento Ciudadano', desc: 'Avisos de privacidad actualizados conforme al Art. 18 de la LGPD, con rutas claras de exclusión para categorías de datos sensibles.', color: GREEN },
  { icon: '🛡️', title: 'Marco de Supervisión del DPO', desc: 'Estructura conjunta de Delegado de Protección de Datos con derechos de auditoría, SLAs de notificación de incidentes y protocolo de reporte a la ANPD.', color: BLUE },
  { icon: '🗑️', title: 'Política de Retención y Eliminación', desc: 'Gestión automatizada del ciclo de vida de datos — los datos replicados expiran según calendarios de retención preaprobados.', color: CYAN },
  { icon: '📝', title: 'Requisitos de Pista de Auditoría', desc: 'Registros de acceso inmutables para todas las consultas sobre datos personales, disponibles para DPOs y autoridades reguladoras bajo demanda.', color: GREEN },
]
      ...
      >
        ...
        <div className="relative z-10 w-[38%] flex flex-col justify-center px-12 lg:px-14 py-14 gap-6 border-r"
          ...
          <motion.h2 initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.35, duration: 0.7 }}
            ...
            Cumplimiento LGPD<br />por diseño
          </motion.h2>
          ...
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.65 }}
            ...
            Cada capa del Data Lake Paulistano está construida con la Ley General de Protección de Datos de Brasil (LGPD) como restricción fundamental — no como una consideración posterior.
          </motion.p>
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.8 }}
            className="text-sm leading-relaxed" style={{ color: 'rgba(255,255,255,0.45)' }}>
            Seis instrumentos legales vinculantes rigen cómo fluyen, se almacenan, acceden y finalmente eliminan los datos ciudadanos — con la infraestructura de cumplimiento de Microsoft como capa de aplicación técnica.
          </motion.p>
          <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.0 }}
            ...
            <span className="text-xs leading-relaxed" style={{ color: 'rgba(255,255,255,0.5)' }}>
              Instrumentos legales redactados conjuntamente por el área Legal de SMIT, Cumplimiento de PRODAM y los equipos de Sector Público de Microsoft.
            </span>
          </motion.div>
        </div>
