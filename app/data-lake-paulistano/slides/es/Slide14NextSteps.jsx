...
const actions = [
  { number: '01', title: 'Aprobar alcance del piloto', desc: 'Definir formalmente el perímetro del data lake SMIT — sistemas, tipos de datos y cronograma para la Fase 1.', owner: 'SMIT + PRODAM', color: CYAN },
  { number: '02', title: 'Firmar MOU con Microsoft', desc: 'Formalizar la intención de alianza con un Memorando de Entendimiento para desbloquear recursos de planificación conjunta.', owner: 'SMIT + Microsoft', color: BLUE },
  { number: '03', title: 'Constituir gobernanza', desc: 'Designar miembros de los comités de Gobernanza de Datos, Operaciones Técnicas y Seguridad y Cumplimiento.', owner: 'SMIT + PRODAM + MS', color: GREEN },
  { number: '04', title: 'Revisión de instrumentos legales', desc: 'El área Legal de SMIT y Cumplimiento de PRODAM revisan y firman los acuerdos de tratamiento de datos conformes a la LGPD.', owner: 'Equipos Legales', color: CYAN },
]
    ...
    <div className="w-full h-full flex items-center justify-center p-6 lg:p-10">
      ...
      >
        ...
        <div className="relative z-10 w-[40%] flex flex-col justify-between px-12 lg:px-14 py-14 border-r"
          ...
          <div className="flex flex-col gap-6">
            <motion.h2 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.35, duration: 0.8 }}
              ...
              Próximos pasos hacia el Data Lake Paulistano
            </motion.h2>
            ...
            <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.7 }}
              ...
              Cuatro decisiones desbloquearán todo el programa. Cada una tiene bajo riesgo, es reversible y sienta las bases para la iniciativa de datos más ambiciosa de São Paulo.
            </motion.p>
          </div>
          ...
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.3 }}
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-mono font-bold tracking-wider" style={{ color: GREEN }}>EL OBJETIVO</span>
            </div>
            <p className="text-sm leading-relaxed" style={{ color: 'rgba(255,255,255,0.5)' }}>
              São Paulo como ciudad totalmente conectada — donde cada secretaría comparte la misma plataforma de datos y cada ciudadano recibe una experiencia de servicio fluida y unificada.
            </p>
        ...
        <div className="absolute top-6 right-8 z-20">
          <span className="text-xs font-mono tracking-widest" style={{ color: 'rgba(255,255,255,0.3)' }}>14 · PRÓXIMOS PASOS</span>
        </div>
      </motion.div>
    </div>
  )
