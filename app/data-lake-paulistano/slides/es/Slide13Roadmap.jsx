...
const phases = [
  {
    ...
    status: 'ACTIVO',
    items: [
      'Lanzamiento del SMIT Data Lake',
      'Firma de la alianza con Microsoft',
      'Formación de comités de gobernanza',
      'Instrumentos LGPD implementados',
    ],
  },
  {
    number: '02',
    ...
    status: 'PLANIFICADO',
    items: [
      'Data lakes de SME y SMS',
      'Vinculación de ID ciudadano entre secretarías',
      'Panel de analítica unificada',
      'Segundo ciclo de gobernanza',
    ],
  },
  {
    number: '03',
    ...
    status: 'HOJA DE RUTA',
    items: [
      'Más de 10 secretarías conectadas',
      'Capa de analítica predictiva',
      'Piloto de visión 360° del ciudadano',
      'Auditoría de cumplimiento ANPD',
    ],
  },
  {
    number: '04',
    ...
    status: 'VISIÓN',
    items: [
      'Las 30+ secretarías en red',
      'Inteligencia municipal en tiempo real',
      'Portal de datos abiertos (curado)',
    ...
    <div className="w-full h-full flex items-center justify-center p-6 lg:p-10">
      ...
      >
        ...
        <div className="relative z-10 flex items-center justify-between px-12 pt-8 pb-5 border-b"
          ...
          <div>
            ...
            <motion.h2 initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.35 }}
              ...
              Del piloto SMIT a la inteligencia municipal
            </motion.h2>
          </div>
        </div>
        ...
        <div className="absolute top-6 right-8 z-20">
          <span className="text-xs font-mono tracking-widest" style={{ color: 'rgba(255,255,255,0.3)' }}>13 · HOJA DE RUTA</span>
        </div>
      </motion.div>
    </div>
  )
