...
const phases = [
  {
    ...
    status: 'АКТИВНО',
    items: [
      'Запуск озера данных SMIT',
      'Подписание партнёрства с Microsoft',
      'Формирование комитетов управления',
      'Инструменты LGPD внедрены',
    ],
  },
  {
    number: '02',
    ...
    items: [
      'Озёра данных SME и SMS',
      'Межведомственная связь ID граждан',
      'Единая аналитическая панель',
      'Второй цикл governance',
    ],
  },
  {
    number: '03',
    ...
    items: [
      '10+ ведомств подключено',
      'Слой прогнозной аналитики',
      'Пилот «Гражданин 360°»',
      'Аудит соответствия ANPD',
    ],
  },
  {
    number: '04',
    ...
    status: 'ВИДЕНИЕ',
    items: [
      'Все 30+ ведомств в сети',
      'Городской интеллект в реальном времени',
      'Портал открытых данных (кураторский)',
    ...
    <div className="w-full h-full flex items-center justify-center p-6 lg:p-10">
      ...
      >
        ...
        <div className="relative z-10 flex items-center justify-between px-12 pt-8 pb-5 border-b"
          ...
          <div>
            ...
            <motion.h2 initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.35 }}
              ...
              От пилота SMIT до городского интеллекта
            </motion.h2>
          </div>
        </div>
        ...
        <div className="absolute top-6 right-8 z-20">
          <span className="text-xs font-mono tracking-widest" style={{ color: 'rgba(255,255,255,0.3)' }}>13 · ДОРОЖНАЯ КАРТА</span>
        </div>
      </motion.div>
    </div>
  )
