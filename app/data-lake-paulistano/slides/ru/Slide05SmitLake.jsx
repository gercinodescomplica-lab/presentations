...
const systems = [
  { icon: '📞', name: '156', desc: 'Портал запросов на обслуживание и жалоб граждан', tag: 'Базовая служба' },
  { icon: '🎓', name: 'Descomplica SP', desc: 'Платформа упрощения цифровых услуг', tag: 'Цифровое правительство' },
  { icon: '📅', name: 'Система записи', desc: 'Муниципальная запись на приём и учёт посещаемости', tag: 'Операции' },
  { icon: '🪪', name: 'Цифровое удостоверение', desc: 'Единая платформа идентификации 156', tag: 'Идентификация' },
    ...
    <div className="w-full h-full flex items-center justify-center p-6 lg:p-10">
      ...
      >
        ...
        <div className="absolute top-6 right-8 z-20">
          <span className="text-xs font-mono tracking-widest" style={{ color: 'rgba(255,255,255,0.3)' }}>05 · ОЗЕРО ДАННЫХ SMIT</span>
        </div>
      </motion.div>
    </div>
  )
