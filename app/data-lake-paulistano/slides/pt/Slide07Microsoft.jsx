...
const pillars = [
  { icon: '📄', title: 'Contrato Direto', desc: 'A Prefeitura de São Paulo assina diretamente com a Microsoft — sem intermediários ou sobrepreços de revendedores.' },
  { icon: '🤝', title: 'Patrocínio Estratégico', desc: 'A Microsoft entra como parceira estratégica, não apenas como fornecedora de nuvem.' },
  { icon: '🏗️', title: 'Solução Coconstruída', desc: 'Arquitetura desenhada conjuntamente com engenheiros Microsoft desde o primeiro dia.' },
      ...
      >
        ...
        <div className="relative z-10 w-[42%] flex flex-col justify-center px-12 lg:px-14 py-14 gap-6 border-r"
          ...
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.8 }}
            ...
            O acordo comercial seria estruturado como um contrato direto entre a Prefeitura e a Microsoft — garantindo controle total, transparência e condições favoráveis compatíveis com a escala de uma parceria de cidade global.
          </motion.p>
