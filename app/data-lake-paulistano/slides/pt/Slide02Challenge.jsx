...
const pains = [
  { icon: '🗂️', title: 'Dados presos em silos', desc: 'Cada secretaria gerencia seus próprios bancos de dados isolados, sem acesso compartilhado.' },
  { icon: '🔁', title: 'Esforços duplicados', desc: 'Os mesmos dados do cidadão são coletados e armazenados múltiplas vezes em diferentes órgãos.' },
  ...
  { icon: '⏳', title: 'Tempo de resposta lento', desc: 'Demandas entre secretarias levam dias ou semanas devido à troca manual de dados.' },
]
      ...
      >
        ...
        <div className="relative z-10 w-[42%] flex flex-col justify-center px-12 lg:px-14 py-14 gap-6 border-r"
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }}
            ...
            <span className="text-sm tracking-wide" style={{ color: 'rgba(255,255,255,0.4)' }}>O custo da fragmentação</span>
          </motion.div>
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.65 }}
            className="text-sm leading-relaxed" style={{ color: 'rgba(255,255,255,0.5)' }}>
            Mais de 30 secretarias municipais geram dados diariamente — mas poucos fluem de forma integrada. O resultado: desperdício, duplicação e pontos cegos.
          </motion.p>
        ...
        <div className="absolute top-6 right-8 z-20">
          <span className="text-xs font-mono tracking-widest" style={{ color: 'rgba(255,255,255,0.3)' }}>02 · O DESAFIO</span>
        </div>
      </motion.div>
    </div>
  )
