...
const items = [
  { icon: '🏛️', title: 'Модуль Собраний', desc: 'Упрощённая версия онлайн-урны для голосования на собраниях с компактным администрированием.', color: BLUE, status: 'Запланировано' },
    ...
    <SlideCardLight slideNum="06" label="ДОРОЖНАЯ КАРТА 2026">
      <div className="flex h-full">
        <LeftPanelLight>
          ...
          <p className="text-slate-700 text-base leading-relaxed">Платформа эволюционирует с каждым избирательным циклом, внедряя ИИ и новые функции.</p>
