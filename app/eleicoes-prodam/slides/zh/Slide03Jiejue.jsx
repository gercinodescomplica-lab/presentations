...
const modules = [
  { icon: '🖥️', name: '在线投票系统', desc: '与Microsoft 365集成的远程投票解决方案', color: BLUE, tag: '选民' },
  { icon: '🏛️', name: '现场投票系统', desc: '适用于大型委员会的投票员副本系统', color: GREEN, tag: '监票员' },
  { icon: '📊', name: 'TSE计票系统', desc: '读取TSE电子投票机报告', color: CYAN, tag: '委员会' },
  { icon: '⚙️', name: '后台管理系统', desc: '客户自主管理选举流程', color: GOLD, tag: '管理员' },
]
