...
const modules = [
  { icon: '🖥️', name: 'Urna en Línea', desc: 'Votación remota integrada con Microsoft 365', color: BLUE, tag: 'Elector' },
  { icon: '🏛️', name: 'Urna Presencial', desc: 'Sistema réplica de mesa electoral para grandes consejos', color: GREEN, tag: 'Interventor' },
  { icon: '📊', name: 'Escrutinio TSE', desc: 'Lectura de actas de urna electrónica del TSE', color: CYAN, tag: 'Comisión' },
  { icon: '⚙️', name: 'Backoffice', desc: 'Gestión autónoma por el propio cliente', color: GOLD, tag: 'Administrador' },
]
