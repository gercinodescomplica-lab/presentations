    ...
    <SlideCardLight slideNum="04" label="DIFERENCIALES">
      <div className="flex h-full">
        <LeftPanelLight>
          ...
          <p className="text-slate-700 text-base leading-relaxed">PRODAM no solo provee el sistema — está presente en cada etapa del proceso electoral, garantizando que todo funcione en el momento preciso.</p>
