    ...
    <SlideCardLight slideNum="02" label="EL DESAFÍO">
      <div className="flex h-full">
        <LeftPanelLight>
          ...
          <p className="text-slate-500 text-base leading-relaxed">Las elecciones tienen una ventana de ejecución concentrada en pocas horas. La visibilidad institucional es máxima y cualquier fallo compromete la credibilidad del organismo.</p>
