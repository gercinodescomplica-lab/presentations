    ...
    <SlideCardLight slideNum="06" label="ROADMAP 2026">
      <div className="flex h-full">
        <LeftPanelLight>
          ...
          <p className="text-slate-700 text-base leading-relaxed">La plataforma evoluciona en cada ciclo electoral, incorporando inteligencia artificial y nuevas funcionalidades.</p>
