...
const stats = [
  { value: '+20', label: 'Eleições realizadas', color: BLUE },
  { value: '690K', label: 'Eleitores atendidos', color: GREEN },
  { value: '+1M', label: 'Votos processados', color: GOLD },
]

const clients = ['CMDCA', 'IPREM', 'COMAS', 'CMH', 'CPM', 'CMPU', 'SMADS', 'SEHAB', 'PRODAM']

export default function Slide05Credibilidade() {
  return (
    <SlideCardLight slideNum="05" label="CREDIBILIDADE">
      <div className="flex h-full">
        <LeftPanelLight>
          <TagLabelLight color={GOLD}>Credibilidade</TagLabelLight>

          <GradientTitleLight>
            Resultados que<br />comprovam<br />a solução
          </GradientTitleLight>

          <SubtitleBarLight>Histórico comprovado em São Paulo</SubtitleBarLight>
          ...
          >
            <span className="text-[10px] font-mono font-semibold tracking-wider" style={{ color: BLUE }}>DESTAQUES 2025</span>
            <ul className="flex flex-col gap-1.5">
              {[
                '6 processos eleitorais de alta complexidade',
                'Novo módulo administrativo entregue',
                'Nova Urna Online implantada',
              ].map((item, i) => (
            ...
            <div className="flex flex-wrap gap-2">
              {clients.map((client, i) => (
                <motion.div
                  ...
                  className="px-3 py-1.5 rounded-lg text-xs font-mono font-medium tracking-wide text-slate-600 bg-slate-50"
