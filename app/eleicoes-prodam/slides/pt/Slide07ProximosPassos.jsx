  ...
  return (
    <div className="w-full h-full flex items-center justify-center p-6 lg:p-10">
      <motion.div
        ...
        className="relative w-full h-full max-w-[1400px] max-h-[820px] rounded-3xl overflow-hidden flex flex-col items-center justify-center gap-10 px-16 bg-white"
        style={{
          border: '1px solid rgba(26,86,219,0.12)',
          boxShadow: '0 20px 80px -20px rgba(26,86,219,0.14)',
        }}
      >
        ...
        <div
          ...
          style={{
            backgroundImage: 'linear-gradient(rgba(26,86,219,1) 1px, transparent 1px), linear-gradient(90deg, rgba(26,86,219,1) 1px, transparent 1px)',
        ...
        <div className="relative z-10 flex flex-col items-center gap-4 text-center">
          <motion.div
            ...
            className="flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-mono font-semibold tracking-wider"
            style={{ border: `1px solid ${GREEN}30`, background: `${GREEN}08`, color: GREEN }}
          >
          ...
          >
            Vamos garantir o sucesso<br />da sua próxima eleição?
          </motion.h2>
        </div>
        ...
        <div className="relative z-10 flex gap-6 w-full max-w-3xl">
          {steps.map(({ number, icon, title, desc, color }, i) => (
            <motion.div
              ...
              className="flex-1 flex flex-col gap-4 p-6 rounded-2xl bg-white relative overflow-hidden"
              style={{ border: `1px solid ${color}18`, boxShadow: '0 8px 32px -8px rgba(0,0,0,0.08)' }}
            >
              ...
              <div className="flex items-center justify-between">
                <div className="w-10 h-10 rounded-xl flex items-center justify-center text-xl" style={{ background: `${color}10` }}>{icon}</div>
                <span className="font-heading font-bold text-3xl" style={{ color: `${color}25` }}>{number}</span>
              </div>
        ...
        <motion.div
          ...
          className="relative z-10 flex flex-col items-center gap-4 max-w-2xl text-center"
        >
