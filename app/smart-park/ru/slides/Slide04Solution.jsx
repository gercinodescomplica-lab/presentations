...
export default function Slide04Solution() {
  const layers = [
    {
      title: 'Edge — Аппаратный слой',
      items: ['Умные опоры с регулируемым LED (Zigbee/LoRaWAN)', 'Микро-локальные метеостанции (PM2.5, NO₂, CO₂, шум)', 'Точный полив с датчиками почвы (40% экономия воды)'],
      color: '#4ADE80',
    },
    {
      title: 'Слой безопасности и ИИ',
      items: ['Компьютерное зрение: неинвазивное обнаружение паттернов', 'Цифровая кнопка паники: двунаправленные экстренные стелы', 'Оповещения о рискованном поведении и оставленных предметах в реальном времени'],
      color: '#F59E0B',
    },
    {
      title: 'Слой связности',
      items: ['Wi-Fi 6 покрытие для граждан', 'Инфраструктура 5G-ready small cell', 'Возможность дохода для телеком-операторов'],
      color: '#4ADE80',
    },
  ]
    ...
    <div className="w-full h-full flex items-center justify-center p-6 lg:p-10">
      ...
      >
        ...
        <div className="absolute top-6 left-8 flex items-center gap-2 z-20">
          ...
          <span className="text-white/15 text-xs font-mono tracking-widest">АРХИТЕКТУРА</span>
        </div>
        ...
        <div className="relative z-10 flex flex-col h-full px-14 lg:px-16 py-20 gap-6">
          ...
          >
            ...
            <span className="font-heading font-light text-base tracking-wide text-white/55">Оборудование · ИИ · Связь</span>
          </motion.div>
