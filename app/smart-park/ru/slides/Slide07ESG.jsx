  ...
  const pillars = [
    {
      letter: 'S',
      title: 'Социальный',
      items: ['Цифровая инклюзия: демократизированный высокоскоростной интернет', 'Доступная навигация: тактильные и аудиокарты через QR-код для слабовидящих'],
      color: '#4ADE80',
    },
    {
      letter: 'E',
      title: 'Экологический',
      items: ['Данные о микроклимате направляют город в отношении посадки деревьев', 'Снижает местную температуру через умное орошение и планирование зелёного покрытия'],
      color: '#F59E0B',
    },
    {
      letter: 'G',
      title: 'Управление',
      items: ['Панель прозрачности: граждане видят экономию энергии и качество воздуха в реальном времени', 'Открытые данные укрепляют доверие между gov и сообществом'],
      color: '#4ADE80',
    },
  ]
        ...
        <div className="relative z-10 flex flex-col h-full px-14 lg:px-16 py-20 gap-6">
          ...
          >
            <span className="text-xs font-mono tracking-[0.2em] uppercase" style={{ color: '#4ADE80' }}>
              Социальное воздействие и управление
            </span>
          </motion.div>
          ...
          >
            ...
            <span className="font-heading font-light text-base tracking-wide text-white/55">S · Социальный | E · Экологический | G · Управление</span>
          </motion.div>
