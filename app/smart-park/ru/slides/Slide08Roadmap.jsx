  ...
  const phases = [
    {
      ...
      items: ['Быстрая установка в выбранном парке', 'Калибровка датчиков и тестирование ИИ', 'Сбор первых данные с реальных пешеходов'],
      color: '#4ADE80',
    },
    {
      phase: 'Фаза 2',
      title: 'Расширение функций',
      items: ['Добавление обратной связи граждан через приложение', 'Интеграция со службами экстренной помощи', 'Запуск программы лояльности для парков'],
      color: '#F59E0B',
    },
    {
      phase: 'Фаза 3',
      title: 'Масштабирование',
      items: ['Дублирование модели в соседних районах', 'Создание инструментария для быстрого развёртывания', 'Монетизация через спонсорство и данные'],
      color: '#4ADE80',
    },
    {
      phase: 'Фаза 4',
      title: 'Экосистема',
      items: ['Платформа «Парк как услуга» для каждого района', 'AI-коуч здоровья, работающий со всеми возрастами', 'Прозрачный город: данные в реальном времени'],
      color: '#F59E0B',
    },
  ]
    ...
    <div className="w-full h-full flex items-center justify-center p-6 lg:p-10">
      ...
      >
        ...
        <div className="absolute top-6 left-8 flex items-center gap-2 z-20">
          ...
          <span className="text-white/15 text-xs font-mono tracking-widest">ДОРОЖНАЯ КАРТА</span>
        </div>
        ...
        <div className="relative z-10 flex flex-col h-full px-14 lg:px-16 py-20 gap-6">
          ...
          >
            ...
            <span className="font-heading font-light text-base tracking-wide text-white/55">От пилотного проекта до городской экосистемы</span>
          </motion.div>
            ...
            {phases.map((phase, i) => (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="h-px flex-1 rounded-full" style={{ background: `linear-gradient(90deg, ${phase.color}30, transparent)` }} />
                </div>
                <span className="text-sm font-mono tracking-widest uppercase" style={{ color: phase.color }}>{phase.title}</span>
