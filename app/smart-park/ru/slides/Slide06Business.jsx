...
export default function Slide06Business() {
  const revenueStreams = [
    { source: 'Права на название', desc: 'Бренды платят за права на название пространства или конкретных зон.', impact: 'Высокая предсказуемость денежного потока', color: '#4ADE80' },
    { source: 'Монетизация данных', desc: 'Продажа агрегированных данных о пешеходном потоке местной торговле.', impact: 'ROI технологий', color: '#F59E0B' },
    { source: 'Частная эксплуатация', desc: 'Партнёр берёт на себя 100% обслуживания (уборка и освещение).', impact: 'Немедленное бюджетное облегчение', color: '#4ADE80' },
  ]

  const savings = [
    { value: '65%', label: 'Снижение счёта за электроэнергию благодаря автоматизации', color: '#4ADE80' },
    { value: '30%', label: 'Снижение затрат на ремонт благодаря активному наблюдению', color: '#F59E0B' },
  ]
    ...
    <div className="w-full h-full flex items-center justify-center p-6 lg:p-10">
      ...
      >
        ...
        <div className="absolute top-6 left-8 flex items-center gap-2 z-20">
          ...
          <span className="text-white/15 text-xs font-mono tracking-widest">БИЗНЕС-МОДЕЛЬ</span>
        </div>
        ...
        <div className="relative z-10 flex flex-col h-full px-14 lg:px-16 py-20 gap-6">
          ...
          >
            ...
            <span className="font-heading font-light text-base tracking-wide text-white/55">От центра затрат к генератору дохода</span>
          </motion.div>
            ...
            {revenueStreams.map((item, i) => (
              ...
              >
                ...
                <div className="mt-auto pt-2 border-t border-white/5">
                  <span className="text-white/60 text-xs font-mono tracking-wider">ВЛИЯНИЕ: {item.impact}</span>
                </div>
              </motion.div>
            ))}
          </div>
