    ...
    <div className="w-full h-full flex items-center justify-center p-6 lg:p-10">
      ...
      >
        ...
        <div className="absolute top-6 left-8 flex items-center gap-2 z-20">
          ...
          <span className="text-white/15 text-xs font-mono tracking-widest">ВИДЕНИЕ</span>
        </div>

        <div className="relative z-10 flex h-full">
          <div className="w-[45%] flex-shrink-0 border-r border-white/[0.04] flex flex-col justify-center px-14 lg:px-16 py-20 gap-5">
            <motion.div
            ...
            >
              ...
              <span className="font-heading font-light text-base tracking-wide text-white/55">Интеллектуальный городской узел</span>
            </motion.div>
            ...
            >
              При 80% бразильцев, живущих в городах, общественное пространство стало критическим активом для психического здоровья, безопасности и данных. Smart Park превращает центры затрат (заброшенные парки) в центры ценности (узлы данных и благополучия).
            </motion.p>
            ...
            >
              ...
              <span className="text-[#F59E0B] text-xs font-mono tracking-widest">МОДЕЛЬ IaaS</span>
            </motion.div>
          </div>

          <div className="flex-1 flex flex-col justify-center px-10 lg:px-12 py-20 gap-3 overflow-hidden">
            {[
              { label: 'Здоровье и благополучие', desc: 'Общественные пространства напрямую влияют на психическое здоровье и сплочённость сообщества.', color: '#4ADE80' },
              { label: 'Безопасность прежде всего', desc: 'Интеллектуальный мониторинг снижает преступность и вандализм через данные в реальном времени.', color: '#F59E0B' },
              { label: 'Центр данных', desc: 'Парки становятся датчиками города: климат, шум, качество воздуха, пешеходный поток.', color: '#4ADE80' },
              { label: 'От затрат к ценности', desc: 'Сдвиг от бремени обслуживания к генерирующей доход интеллектуальной инфраструктуре.', color: '#F59E0B' },
            ].map((block, i) => (
              <motion.div
                key={block.label}
