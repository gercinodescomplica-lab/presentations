...
export default function Slide03Market() {
  const stats = [
    { value: '$2.5T', label: 'Рынок умных городов к 2026', color: '#4ADE80' },
    { value: '80%', label: 'Горожане в Бразилии', color: '#F59E0B' },
    { value: '3', label: 'Макротенденции', color: '#4ADE80' },
  ]

  const trends = [
    {
      title: 'ESG (Environmental, Social, and Governance)',
      desc: 'Компаниям нужны реальные проекты для инвестирования капитала воздействия.',
      color: '#4ADE80',
    },
    {
      title: 'Edge Computing',
      desc: 'Обработка данных на месте снижает задержку для общественной безопасности.',
      color: '#F59E0B',
    },
    {
      title: 'Городская устойчивость',
      desc: 'Города должны отслеживать микроклимат для борьбы с островами тепла.',
      color: '#4ADE80',
    },
  ]
    ...
    <div className='w-full h-full flex items-center justify-center p-6 lg:p-10'>
      ...
      >
        ...
        <div className='relative z-10 flex flex-col h-full px-14 lg:px-16 py-20 gap-8'>
          ...
          >
            Глобальные тренды, локальное влияние
          </motion.h2>
