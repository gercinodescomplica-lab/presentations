...
export default function Slide03Market() {
  const stats = [
    {
      value: '$2.5T',
      label: 'Mercado de Ciudades Inteligentes en 2026',
      color: '#4ADE80',
    },
    { value: '80%', label: 'Población Urbana en Brasil', color: '#F59E0B' },
    { value: '3', label: 'Macrotendencias Abordadas', color: '#4ADE80' },
  ]

  const trends = [
    {
      title: 'ESG (Environmental, Social, and Governance)',
      desc: 'Las empresas necesitan proyectos tangibles para invertir capital de impacto.',
      color: '#4ADE80',
    },
    {
      title: 'Edge Computing',
      desc: 'El procesamiento de sensores in situ reduce la latencia para seguridad pública.',
      color: '#F59E0B',
    },
    {
      title: 'Resiliencia Urbana',
      desc: 'Las ciudades deben monitorear microclimas para combatir islas de calor.',
      color: '#4ADE80',
    },
  ]
