...
export default function Slide09Closing() {
  const risks = [
    { risk: 'Obsolescencia Técnica', mitigation: 'Cláusulas de renovación de hardware cada 36 meses', color: '#4ADE80' },
    { risk: 'Discontinuidad Política', mitigation: 'Contratos de concesión de 10+ años con garantías legales de PPP', color: '#F59E0B' },
  ]
    ...
    <div className="w-full h-full flex items-center justify-center p-6 lg:p-10">
      ...
      >
        ...
        <div className="absolute top-6 left-8 flex items-center gap-2 z-20">
          ...
          <span className="text-white/15 text-xs font-mono tracking-widest">CONCLUSIÓN</span>
        </div>
        ...
        <div className="relative z-10 w-[55%] flex-shrink-0 flex flex-col justify-center px-14 lg:px-16 py-20 gap-6">
          ...
          >
            ...
            <span className="font-heading font-light text-base tracking-wide text-white/55">Infraestructura Crítica</span>
          </motion.div>
          ...
          >
            Smart Park resuelve el problema de la gestión urbana mientras posiciona a la ciudad y sus socios a la vanguardia de la tecnología global. Es prueba física de que la innovación puede — y debe — ser pública y democrática.
          </motion.p>
          ...
          >
            ...
            <span className="text-[#4ADE80] text-xs font-mono tracking-widest">LISTO PARA DESPLEGAR</span>
          </motion.div>
        </div>
        ...
        <div className="flex-1 flex flex-col justify-center px-10 lg:px-12 py-20 gap-6">
          ...
          >
            ...
            <div className="flex items-center gap-4">
              <span className="text-white/30 text-xs font-mono tracking-widest uppercase">Próximo Paso</span>
              <span className="text-white/60 text-sm">Iniciar negociación PPP 2.0 y selección de sitio piloto</span>
            </div>
          </motion.div>
        </div>
      </motion.div>
