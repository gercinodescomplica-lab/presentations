...
export default function Slide08Roadmap() {
  const phases = [
    { number: '01', label: 'Diagnóstico', desc: 'Auditoría de infraestructura y estudio de conectividad local. Meses 1–2.', color: '#4ADE80' },
    { number: '02', label: 'Despliegue Core', desc: 'Instalación de postes inteligentes y backbone de fibra. Meses 3–5.', color: '#F59E0B' },
    { number: '03', label: 'Inteligencia', desc: 'Activación de sensores, seguridad con IA y plataforma de datos. Meses 6–7.', color: '#4ADE80' },
    { number: '04', label: 'Lanzamiento', desc: 'Eventos de activación comunitaria y dashboard público. Mes 8+.', color: '#F59E0B' },
  ]
      ...
      >
        ...
        <div className="relative z-10 flex flex-col h-full px-14 lg:px-16 py-20 gap-6">
          ...
          >
            ...
            <span className="font-heading font-light text-base tracking-wide text-white/55">Plan de Implementación de 8 Meses</span>
          </motion.div>
