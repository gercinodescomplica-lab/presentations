  ...
  const pillars = [
    {
      letter: 'S',
      title: 'Social',
      items: ['Inclusión Digital: internet de alta velocidad democratizado', 'Accesibilidad de Orientación: mapas táctiles y de audio vía QR para personas con discapacidad visual'],
      color: '#4ADE80',
    },
    {
      letter: 'E',
      title: 'Ambiental',
      items: ['Los datos de microclima guían a la ciudad sobre dónde plantar más árboles', 'Reduce la temperatura local mediante riego inteligente y planificación de cobertura verde'],
      color: '#F59E0B',
    },
    {
      letter: 'G',
      title: 'Gobernanza',
      items: ['Panel de Transparencia: ciudadanos ven ahorros de energía y calidad del aire en tiempo real', 'Los datos abiertos generan confianza entre gobierno y comunidad'],
      color: '#4ADE80',
    },
  ]
      ...
      >
        ...
        <div className="relative z-10 flex flex-col h-full px-14 lg:px-16 py-20 gap-6">
          ...
          >
            ...
            <span className="font-heading font-light text-base tracking-wide text-white/55">S · Social | E · Ambiental | G · Gobernanza</span>
          </motion.div>
