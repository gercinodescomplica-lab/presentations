...
export default function Slide05Security() {
  const features = [
    { label: 'Visión por Computadora', desc: 'Monitoreo no invasivo que detecta multitudes, comportamiento de riesgo y objetos abandonados en tiempo real.', color: '#4ADE80' },
    { label: 'Botón de Pánico Digital', desc: 'Totems de emergencia con comunicación bidireccional directamente al centro de monitoreo.', color: '#F59E0B' },
    { label: 'Iluminación Inteligente', desc: 'Postes LED adaptativos que se iluminan al detectar movimiento, disuadiendo el crimen y ahorrando energía.', color: '#4ADE80' },
    { label: 'Alertas Predictivas', desc: 'Modelos de IA analizan patrones para alertar a las autoridades antes de que los incidentes escalen.', color: '#F59E0B' },
  ]
    ...
    <div className="w-full h-full flex items-center justify-center p-6 lg:p-10">
      ...
      >
        ...
        <div className="absolute top-6 left-8 flex items-center gap-2 z-20">
          ...
          <span className="text-white/15 text-xs font-mono tracking-widest">SEGURIDAD</span>
        </div>
        ...
        <div className="relative z-10 flex h-full">
          <div className="w-[42%] flex-shrink-0 border-r border-white/[0.04] flex flex-col justify-center px-14 lg:px-16 py-20 gap-5">
            ...
            >
              ...
              <span className="font-heading font-light text-base tracking-wide text-white/55">Seguridad Pública Impulsada por IA</span>
            </motion.div>
            ...
            >
              La seguridad no es solo vigilancia — es prevención, capacidad de respuesta y confianza ciudadana. Nuestra capa de IA transforma cámaras pasivas en guardianes activos del espacio público.
            </motion.p>
            ...
            >
              ...
              <span className="text-[#4ADE80] text-xs font-mono tracking-widest">NO INVASIVO</span>
            </motion.div>
          </div>
