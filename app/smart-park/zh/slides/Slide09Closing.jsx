...
export default function Slide09Closing() {
  const risks = [
    { risk: '技术过时', mitigation: '每36个月硬件更新条款', color: '#4ADE80' },
    { risk: '政治断续', mitigation: '10年以上PPP特许经营合同与法律保障', color: '#F59E0B' },
  ]
    ...
    <div className="w-full h-full flex items-center justify-center p-6 lg:p-10">
      ...
      >
        ...
        <div className="absolute top-6 left-8 flex items-center gap-2 z-20">
          ...
          <span className="text-white/15 text-xs font-mono tracking-widest">结语</span>
        </div>
        ...
        <div className="relative z-10 w-[55%] flex-shrink-0 flex flex-col justify-center px-14 lg:px-16 py-20 gap-6">
          ...
          >
            ...
            <span className="font-heading font-light text-base tracking-wide text-white/55">关键基础设施</span>
          </motion.div>
          ...
          >
            智慧公园在解决城市管理问题的同时，将城市及其合作伙伴置于全球技术前沿。它是创新可以是、也应该是公共和民主的有力证明。
          </motion.p>
          ...
          >
            ...
            <span className="text-[#4ADE80] text-xs font-mono tracking-widest">准备部署</span>
          </motion.div>
        </div>
        ...
        <div className="flex-1 flex flex-col justify-center px-10 lg:px-12 py-20 gap-6">
          ...
          >
            ...
            <div className="flex items-center gap-4">
              <span className="text-white/30 text-xs font-mono tracking-widest uppercase">下一步</span>
              <span className="text-white/60 text-sm">启动PPP 2.0谈判并选择试点场地</span>
            </div>
          </motion.div>
        </div>
      </motion.div>
