...
export default function Slide03Market() {
  const stats = [
    { value: '$2.5T', label: '智慧城市市场 (2026年)', color: '#4ADE80' },
    { value: '80%', label: '巴西城市人口', color: '#F59E0B' },
    { value: '3', label: 'macro趋势应对', color: '#4ADE80' },
  ]

  const trends = [
    {
      title: 'ESG (Environmental, Social, and Governance)',
      desc: '企业需要可落地的项目来投资影响力资本。',
      color: '#4ADE80',
    },
    {
      title: '边缘计算',
      desc: '现场传感器处理降低公共安全延迟。',
      color: '#F59E0B',
    },
    {
      title: '城市韧性',
      desc: '城市需监测微气候以应对热岛效应。',
      color: '#4ADE80',
    },
  ]
