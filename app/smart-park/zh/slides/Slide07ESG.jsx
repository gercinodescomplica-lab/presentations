  ...
  const pillars = [
    {
      letter: 'S',
      title: '社会',
      items: ['数字包容: 民主化的高速互联网接入', '无障碍导航: 视障人士可通过二维码获取触觉和语音地图'],
      color: '#4ADE80',
    },
    {
      letter: 'E',
      title: '环境',
      items: ['微气候数据指导城市在哪里种植更多树木', '通过智能灌溉和绿色覆盖规划降低当地温度'],
      color: '#F59E0B',
    },
    {
      letter: 'G',
      title: '治理',
      items: ['透明度仪表板: 市民实时查看能源节省和空气质量', '开放数据建立政府与社区之间的信任'],
      color: '#4ADE80',
    },
  ]
      ...
      >
        ...
        <div className="relative z-10 flex flex-col h-full px-14 lg:px-16 py-20 gap-6">
          ...
          >
            ...
            <span className="font-heading font-light text-base tracking-wide text-white/55">S · 社会 | E · 环境 | G · 治理</span>
          </motion.div>
