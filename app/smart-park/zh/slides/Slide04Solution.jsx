...
export default function Slide04Solution() {
  const layers = [
    {
      title: '边缘层 — 硬件层',
      items: ['带调光LED的智能灯杆 (Zigbee/LoRaWAN)', '微型本地气象站 (PM2.5, NO₂, CO₂, 噪音)', '土壤传感器精准灌溉 (节水40%)'],
      color: '#4ADE80',
    },
    {
      title: '安全与AI层',
      items: ['计算机视觉: 非侵入式模式检测', '数字 panic button: 双向应急图腾', '实时风险行为和遗留物品警报'],
      color: '#F59E0B',
    },
    {
      title: '连接层',
      items: ['市民Wi-Fi 6覆盖', '5G就绪的小基站基础设施', '电信运营商创收机会'],
      color: '#4ADE80',
    },
  ]
    ...
    <div className="w-full h-full flex items-center justify-center p-6 lg:p-10">
      ...
      >
        ...
        <div className="absolute top-6 left-8 flex items-center gap-2 z-20">
          ...
          <span className="text-white/15 text-xs font-mono tracking-widest">架构</span>
        </div>
        ...
        <div className="relative z-10 flex flex-col h-full px-14 lg:px-16 py-20 gap-6">
          ...
          >
            ...
            <span className="font-heading font-light text-base tracking-wide text-white/55">硬件 · 人工智能 · 连接</span>
          </motion.div>
