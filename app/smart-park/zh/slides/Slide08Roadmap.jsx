...
export default function Slide08Roadmap() {
  const phases = [
    { number: '01', label: '诊断', desc: '基础设施审计和本地连接调查。第1-2个月。', color: '#4ADE80' },
    { number: '02', label: '核心部署', desc: '智能灯杆安装和光纤骨干网。第3-5个月。', color: '#F59E0B' },
    { number: '03', label: '智能化', desc: '传感器激活、AI安全和数据平台。第6-7个月。', color: '#4ADE80' },
    { number: '04', label: '上线', desc: '社区激活活动和公共仪表板。第8个月起。', color: '#F59E0B' },
  ]
    ...
    <div className="w-full h-full flex items-center justify-center p-6 lg:p-10">
      ...
      >
        ...
        <div className="absolute top-6 left-8 flex items-center gap-2 z-20">
          ...
          <span className="text-white/15 text-xs font-mono tracking-widest">路线图</span>
        </div>
        ...
        <div className="relative z-10 flex flex-col h-full px-14 lg:px-16 py-20 gap-6">
          ...
          >
            ...
            <span className="font-heading font-light text-base tracking-wide text-white/55">8个月部署计划</span>
          </motion.div>
