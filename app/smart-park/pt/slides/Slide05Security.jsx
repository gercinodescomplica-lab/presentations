...
export default function Slide05Security() {
  const features = [
    { label: 'Computer Vision', desc: 'Monitoramento não invasivo detectando aglomerações, comportamento de risco e objetos abandonados em tempo real.', color: '#4ADE80' },
    { label: 'Botão de Pânico Digital', desc: 'Totens de emergência com comunicação bidirecional direta com a central de monitoramento.', color: '#F59E0B' },
    { label: 'Iluminação Inteligente', desc: 'Postes LED adaptativos que intensificam a luz ao detectar movimento, inibindo crime e economizando energia.', color: '#4ADE80' },
    { label: 'Alertas Preditivos', desc: 'Modelos de IA analisam padrões para alertar autoridades antes que incidentes escalem.', color: '#F59E0B' },
  ]
    ...
    <div className="w-full h-full flex items-center justify-center p-6 lg:p-10">
      ...
      >
        ...
        <div className="absolute top-6 left-8 flex items-center gap-2 z-20">
          ...
          <span className="text-white/15 text-xs font-mono tracking-widest">SEGURANÇA</span>
        </div>
        ...
        <div className="relative z-10 flex h-full">
          <div className="w-[42%] flex-shrink-0 border-r border-white/[0.04] flex flex-col justify-center px-14 lg:px-16 py-20 gap-5">
            ...
            >
              ...
              <span className="font-heading font-light text-base tracking-wide text-white/55">Segurança Pública com IA</span>
            </motion.div>
            ...
            >
              Segurança não é apenas vigilância — é prevenção, resposta rápida e confiança do cidadão.
            </motion.p>
            ...
            >
              ...
              <span className="text-[#4ADE80] text-xs font-mono tracking-widest">NÃO INVASIVO</span>
            </motion.div>
          </div>
