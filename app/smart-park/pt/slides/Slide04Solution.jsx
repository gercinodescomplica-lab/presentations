...
export default function Slide04Solution() {
  const layers = [
    {
      title: 'The Edge — Camada de Hardware',
      items: [
        'Postes Inteligentes com LED',
        'Estações meteorológicas',
        'Irrigação de precisão com sensores de umidade (economia de 40% de água)',
      ],
      color: '#4ADE80',
    },
    {
      ...
      items: [
        'Computer Vision: monitoramento não invasivo de padrões',
        'Botão de Pânico Digital: totens de emergência bidirecionais',
        'Alertas em tempo real de comportamento de risco e objetos abandonados',
      ],
      color: '#F59E0B',
    },
    {
      ...
      items: [
        'Cobertura Wi-Fi 6 para cidadãos',
        'Infraestrutura small cell preparada para 5G',
        'Oportunidade de receita com operadoras de telefonia',
      ],
      color: '#4ADE80',
    },
  ]
