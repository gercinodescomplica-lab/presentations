        ...
        <div className="relative z-10 flex flex-col justify-center px-14 w-[55%]">
          ...
          >
            ...
            <p className="text-slate-600 text-base font-body leading-relaxed max-w-sm">
              Processamento seguro de PDFs e documentos para o setor público.<br />
              <span className="text-slate-400">100% interno. Totalmente aderente à LGPD.</span>
            </p>
          </motion.div>
          ...
          >
            <div>
              <div className="text-slate-400 font-bold text-[10px] font-mono tracking-widest uppercase">Tipo</div>
              <div className="text-slate-500 font-semibold text-xs font-mono mt-0.5">Pitch Deck · 2025</div>
            </div>
            <div className="w-px h-8 bg-slate-200" />
            <div>
              <div className="text-slate-400 font-bold text-[10px] font-mono tracking-widest uppercase">Unidade</div>
              <div className="text-slate-500 font-semibold text-xs font-mono mt-0.5">NMS-2 / SISTEMAS</div>
            </div>
            <div className="w-px h-8 bg-slate-200" />
            <div>
              <div className="text-slate-400 font-bold text-[10px] font-mono tracking-widest uppercase">Versão</div>
              <div className="text-slate-500 font-semibold text-xs font-mono mt-0.5">v1.0 · Jan 2025</div>
            </div>
          </motion.div>
        </div>
