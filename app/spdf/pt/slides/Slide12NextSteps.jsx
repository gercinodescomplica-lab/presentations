...
export default function Slide12NextSteps() {
  return (
    <SlideCardLight slideNum="12" label="ENCERRAMENTO">
      <div className="flex h-full">
        <LeftPanelLight>
          <TagLabelLight color="#eab308">APROVAÇÃO & LANÇAMENTO</TagLabelLight>
          <GradientTitleLight>Equipe & Próximos Passos</GradientTitleLight>
          <SubtitleBarLight>Formando a equipe central de execução</SubtitleBarLight>
          <p className="text-slate-500 text-sm leading-relaxed mb-6">
            A entrega do SPDF será liderada por uma força-tarefa multifuncional dedicada, combinando Gestão de Produto, Engenharia de Software, Arquitetura e protocolos especializados de InfoSec.
          </p>

          <div className="flex flex-wrap gap-2 text-xs font-mono font-bold uppercase">
             <span className="px-3 py-1.5 rounded-md bg-white text-slate-500 border border-slate-200 shadow-sm">Ger. de Produto</span>
             ...
             <span className="px-3 py-1.5 rounded-md bg-white text-slate-500 border border-slate-200 shadow-sm">Especialista InfoSec</span>
          </div>
        </LeftPanelLight>
        ...
        <RightPanelLight className="justify-center items-center">
          ...
          >
            <div className="text-slate-800 text-lg font-heading font-bold mb-2">Fluxo de Aprovação Interno</div>
