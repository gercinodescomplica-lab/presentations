...
export default function Slide06Journey() {
  const steps = [
    {
      ...
      tag: 'ЭТАП 1 · СТАРТ',
      title: 'Привлечение',
      subtitle: 'Бесплатный Бронзовый тариф',
      desc: 'Предлагается напрямую IT-службам и департаментам. До 400 документов/мес и до 1 000 пользователей. Без бюрократии, тендеров и выделения бюджета.',
      badge: 'Стоимость 0 ₽',
      color: '#d97706',
    },
    {
      ...
      tag: 'ЭТАП 2 · РУТИНА',
      title: 'Закрепление',
      subtitle: 'Операционное внедрение',
      desc: 'Сотрудники работают в SPDF ежедневно. Каждая операция повышает безопасность, вытесняет сторонние сайты и формирует здоровую привычку.',
      badge: 'Привычка и безопасность',
      color: '#2563eb',
    },
    {
      num: '03',
      tag: 'ЭТАП 3 · РОСТ',
      title: 'Конверсия',
      subtitle: 'Органический апгрейд',
      desc: 'При превышении 400 документов/мес переход на тарифы Серебро или Золото становится естественным следствием роста документооборота.',
      badge: 'Регулярная выручка',
      color: '#16a34a',
    },
  ]
  ...
  return (
    <WhitePaperCard>
      <WhitePaperHeader
        eyebrow="КОММЕРЧЕСКАЯ ВОРОНКА · ПУТЬ ВНЕДРЕНИЯ"
        title="Трехэтапный цикл освоения платформы"
        subtitle="«Объем документооборота продает платный тариф — а не менеджер по продажам»"
        accentColor="#2563eb"
      />
