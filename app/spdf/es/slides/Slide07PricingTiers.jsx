...
export default function Slide07PricingTiers() {
  const tiers = [
    {
      name: 'Bronce',
      tag: 'ADQUISICIÓN INSTITUCIONAL',
      volume: 'Hasta 400 docs/mes',
      users: 'Hasta 1.000 usuarios',
      price: 'R$ 0',
      period: 'Gratuito permanente',
      cost: 'R$ 5.200 – R$ 6.500',
      margin: 'Inversión de Adquisición',
      highlight: false,
      color: '#d97706',
      badgeBg: 'bg-amber-50',
    ...
    {
      name: 'Plata',
      tag: 'OPERACIÓN ESTÁNDAR',
      volume: '401 a 20.000 docs/mes',
      users: 'Hasta 1.000 usuarios',
      price: 'R$ 12.086,87',
      period: 'mensualidad',
      cost: 'R$ 5.182,77 / mes',
      margin: 'R$ 2.417,38 (20% neto)',
      highlight: true,
      color: '#2563eb',
      badgeBg: 'bg-blue-50',
    ...
    },
    {
      name: 'Oro',
      tag: 'GRAN ESCALA',
      volume: '20.001 a 100.000 docs/mes',
      users: 'Hasta 5.000 usuarios',
      price: 'R$ 15.108,58',
      period: 'mensualidad',
      cost: 'R$ 6.478,46 / mes',
      margin: 'R$ 3.021,72 (20% neto)',
      highlight: false,
      color: '#0f172a',
  ...
  return (
    <WhitePaperCard>
      <WhitePaperHeader
        eyebrow="MODELO ECONÓMICO · GRI / PRODAM"
        title="Estructura de Planes y Sostenibilidad Financiera"
        subtitle="Datos oficiales de cálculo que demuestran que la gratuidad de entrada no genera déficit operativo"
        accentColor="#16a34a"
      />
            ...
            >
              <div>
                ...
                <div className="py-3 px-4 rounded-xl bg-slate-50 border border-slate-100 mb-4">
                  <div className="text-xs text-slate-400 font-mono uppercase tracking-wider">Precio Final</div>
                ...
                <div className="space-y-2 text-xs">
                  <div className="flex justify-between py-1 border-b border-slate-100">
                    <span className="text-slate-500">Costo Est./Cliente:</span>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs lg:text-sm text-slate-700 font-medium">
              &ldquo;Cada suscripción Plata u Oro cubre holgadamente su costo y el de un organismo Bronce asociado. No existe pérdida estructural.&rdquo;
            </span>
          </div>
          <span className="text-[11px] font-mono text-slate-400 flex-shrink-0 ml-4">
            Margen Neto Sostenible: 20%
          </span>
        </motion.div>
      </div>
    </WhitePaperCard>
