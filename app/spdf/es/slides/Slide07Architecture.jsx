...
export default function Slide07Architecture() {
  return (
    <SlideCardLight slideNum="07" label="VISIÓN TÉCNICA">
      <div className="flex h-full">
        <LeftPanelLight>
          <TagLabelLight color="#2563eb">INFRAESTRUCTURA</TagLabelLight>
          <GradientTitleLight>Arquitectura del Sistema</GradientTitleLight>
          <SubtitleBarLight>Construida para escala y disponibilidad absoluta</SubtitleBarLight>
          <p className="text-slate-500 text-sm leading-relaxed">
            SPDF está diseñado para integrarse perfectamente con su infraestructura legada o implementarse en bloques dedicados de nube privada, garantizando alta concurrencia sin comprometer la velocidad.
          </p>
        </LeftPanelLight>
        ...
        <RightPanelLight className="gap-8 flex-col justify-center items-center">
          <div className="flex gap-12 w-full justify-center">
            ...
            >
              ...
              <span className="text-slate-400 text-xs text-center w-32">Instalación directa en el data center</span>
            </motion.div>
            ...
            >
              ...
              <span className="text-yellow-600 font-heading font-bold">Nube Privada</span>
              <span className="text-slate-400 text-xs text-center w-32">Alta disponibilidad aislada</span>
            </motion.div>
          </div>
          ...
          <motion.div
            ...
            >
             ...
             <div className="flex flex-col gap-1 items-center text-center">
                ...
                <span className="text-slate-400 font-bold text-[10px] font-mono tracking-wider uppercase">Usuarios Simultáneos</span>
             </div>
             ...
             <div className="flex flex-col gap-1 items-center text-center">
                ...
                <span className="text-slate-400 font-bold text-[10px] font-mono tracking-wider uppercase">En &lt; 30 Segundos</span>
             </div>
          </motion.div>
        </RightPanelLight>
      </div>
