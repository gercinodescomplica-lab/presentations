...
export default function Slide6bFaturamento() {
  ...
  return (
    <div className="w-full h-full flex bg-[#002B48] text-white overflow-hidden font-sans">
      ...
      {/* ── PAINEL ESQUERDO ── */}
      <div className="w-[24%] h-full flex flex-col justify-between p-10 relative border-r border-[#1E4870] shrink-0" style={{ backgroundColor: '#001F35' }}>
        ...
        <div className="relative z-10 flex flex-col gap-8">
            ...
            <div>
                <motion.h2 className="text-4xl font-bold leading-tight mb-6" style={{ textShadow: '0 0 30px rgba(255,103,29,0.2)' }}>
                    Faturamentos <br/> <span className="text-[#FF671D]">Snapshot</span>
                </motion.h2>
                <div className="space-y-6">
                    ...
                    <div className="p-5 rounded-2xl border border-[#1E4870] bg-[#1E4870]/30 flex flex-col gap-2">
      ...
      <div className="flex-1 h-full relative px-10 py-10 flex flex-col gap-6">
        ...
        <div className="relative z-10 flex justify-between items-end">
            ...
            <div className="flex gap-10 bg-[#001F35] border border-[#1E4870] px-8 py-3 rounded-2xl shadow-xl">
                 <div className="text-right border-r border-[#1E4870] pr-10">
                    <p className="text-[10px] uppercase text-[#4A6580] font-mono tracking-widest mb-1 italic">Realizado Total 2026</p>
                    <p className="text-2xl font-bold text-[#FF671D] font-mono">151.6 Mi</p>
                 </div>
        ...
        <motion.div 
            ...
            className="flex-1 relative z-10 bg-[#001F35]/60 border border-[#1E4870] rounded-3xl overflow-hidden shadow-[0_0_50px_rgba(0,0,0,0.3)] flex flex-col"
        >
          {/* Header */}
          <div className="grid grid-cols-12 gap-4 px-8 py-5 border-b border-[#1E4870] bg-[#1E4870]/40 text-xs font-mono font-bold tracking-wider text-[#4A6580] uppercase items-center">
            ...
            <div className="col-span-2 text-right text-[#FF671D]">Meta Anual</div>
          </div>

          {/* Body - Flex-1 with justify-between to fill vertical space */}
          <div className="flex-1 flex flex-col justify-between overflow-hidden">
             <div className="divide-y divide-[#1E4870]/20 h-full flex flex-col">
                {data.map((row, idx) => (
                <div key={idx} className="flex-1 grid grid-cols-12 gap-4 px-8 items-center hover:bg-[#1E4870]/20 transition-all group">
                    <div className="col-span-3 text-lg font-bold text-white group-hover:text-[#FF671D] transition-colors uppercase tracking-tight">{row.label}</div>
                    <div className="col-span-2 text-right text-base text-[#8FA8BD] font-mono">R$ {row.previsto}</div>
                    <div className="col-span-2 text-right text-base font-bold text-[#FF671D] font-mono">R$ {row.realizado26}</div>
          ...
          <div className="bg-[#FF671D]/10 border-t border-[#FF671D]/30 px-8 py-6 grid grid-cols-12 gap-4 items-center">
            <div className="col-span-3 font-black text-[#FF671D] text-lg uppercase tracking-[0.2em]">TOTAIS</div>
            <div className="col-span-2 text-right font-mono text-xl font-bold text-white/90">1.067.831.098</div>
            <div className="col-span-2 text-right font-mono text-2xl font-bold text-[#FF671D] drop-shadow-[0_0_15px_rgba(255,103,29,0.3)]">151.579.853</div>
