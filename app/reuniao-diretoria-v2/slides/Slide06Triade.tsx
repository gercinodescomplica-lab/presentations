...
export default function Slide3Triade() {
  return (
    <div className="w-full h-full bg-[#002B48] text-white overflow-hidden relative">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div style={{
          ...
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(255,103,29,0.06) 0%, rgba(0,43,72,0.22) 45%, transparent 70%)',
        }} />
      </div>
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.1 }}
        ...
        style={{ color: 'rgba(255,103,29,0.38)' }}>
      ...
      <div className="absolute inset-0 flex items-center justify-center px-4 pt-10 pb-10">
        ...
        >
          <span className="text-[#FF671D] font-bold text-xl text-right">SuperApp</span>
          <div className="w-8 h-px bg-[#FF671D]/40 self-end mb-1" />
          <p className="text-[#8FA8BD] text-lg text-right leading-relaxed">
          ...
          >
            <defs>
              <linearGradient id="g-sl" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%"   stopColor="#FF8A47" stopOpacity="0.93" />
                <stop offset="100%" stopColor="#C4531A" stopOpacity="0.88" />
              </linearGradient>
              <linearGradient id="g-sr" x1="100%" y1="0%" x2="0%" y2="100%">
                <stop offset="0%"   stopColor="#FF671D" stopOpacity="0.93" />
                <stop offset="100%" stopColor="#8A3A12" stopOpacity="0.88" />
              </linearGradient>
              <linearGradient id="g-b" x1="0%" y1="0%" x2="0%" y2="100%">
                <stop offset="0%"   stopColor="#8A3A12" stopOpacity="0.96" />
                <stop offset="100%" stopColor="#3D1A0A" stopOpacity="0.99" />
              </linearGradient>
              <filter id="glow">
            ...
            <polygon points="250,15 30,385 470,385"
              fill="none" stroke="rgba(255,103,29,0.65)" strokeWidth="2" filter="url(#glow)" />
        ...
        <div className="w-[21%] flex-shrink-0 flex flex-col justify-center gap-8 pl-4">
          ...
          >
            <div className="flex items-center gap-2 mb-1">
              <div className="w-6 h-px bg-[#FF671D]/50" />
              <span className="text-[#FF671D] font-bold text-xl">Digital Twin</span>
            </div>
            <p className="text-[#8FA8BD] text-lg leading-relaxed">
          ...
          >
            <div className="flex items-center gap-2 mb-1">
              <div className="w-6 h-px bg-[#FF671D]/50" />
              <span className="text-[#FF671D] font-bold text-xl">Data Lake</span>
            </div>
            <p className="text-[#8FA8BD] text-lg leading-relaxed">
