    ...
    <div className="w-full h-full flex bg-[#0F172A] text-white overflow-hidden">
      ...
      <div className="flex-1 h-full relative px-10 py-8 flex flex-col gap-4 justify-center">
        ...
        >
          ...
          <div className="flex-[1.2] p-4 rounded-xl border border-[#09DFAB]/40 bg-[#0A1120] flex items-center gap-3 shadow-[0_0_20px_rgba(9,223,171,0.12)]">
            <div className="p-2 bg-[#09DFAB]/10 rounded-lg shrink-0 text-[#09DFAB]">
              <Calculator className="w-5 h-5 font-bold" />
            </div>
            <div className="flex flex-col">
              <p className="text-[10px] font-mono text-[#09DFAB] uppercase tracking-wider mb-0.5">Cálculo Estimado (MIPS)</p>
              <p className="text-[13px] text-white font-medium leading-tight">
                 Ex: SEGES tem <span className="text-[#09DFAB]">3 MIPS</span> (R$ 10k/cada) <br/>
                 <span className="text-white/70">Total:</span> <strong className="text-[#09DFAB] text-sm">R$ 30.000,00 / mês</strong>
              </p>
            </div>
          </div>
        </motion.div>
