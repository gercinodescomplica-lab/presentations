...
const reasons = [
  { icon: Cpu, color: '#7C3AED', title: 'AI已达到拐点', desc: 'LLM现在能理解上下文、调用真实API并对实时数据进行推理 — 配置得当时不会产生幻觉。' },
  { icon: Smartphone, color: '#25D366', title: 'WhatsApp在巴西的渗透率达98%', desc: '这是唯一一个所有人全天都保持打开的应用。渠道已经安装就绪 — 零采用障碍。' },
  { icon: Zap, color: '#F59E0B', title: 'AI + 渠道 + 真实数据 = 真正替代人工', desc: '这不是FAQ聊天机器人。这是一个真正替代手动、重复、耗时工作的助理。' },
]
