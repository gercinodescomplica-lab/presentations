...
const conversations = [
  ...
  {
    label: 'Voz y Documentos',
    color: '#F59E0B',
    exchanges: [
      { from: 'user', text: '[audio de 2 minutos]', isAudio: true },
      { from: 'jarvis', text: '🎤 Transcrito y guardado en memoria.\n"Encuentra la cláusula de penalización en el contrato FMS"\n→ Cláusula 14.3, página 28: "…"' },
    ],
  },
]
      ...
      <motion.div initial={{ opacity: 0, scale: 0.97 }} animate={{ opacity: 1, scale: 1 }}
        ...
        <div className="shrink-0 px-12 pt-10 pb-6">
          ...
          <motion.h2 initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}
            ...
            Solo pregunta. En lenguaje natural. En cualquier formato.
          </motion.h2>
        </div>
