...
const caps = [
  { icon: FileText, color: '#7C3AED', label: 'Contracts', examples: ['Which contracts expire in 90 days?', 'Who manages the PGM contract?', 'What is the highest outstanding balance?'] },
  { icon: FolderKanban, color: '#0EA5E9', label: 'Projects', examples: ['Which projects are delayed?', 'Create a task in Notion', 'What\'s the status of project X?'] },
  { icon: CalendarDays, color: '#25D366', label: 'Calendar', examples: ['What do I have today?', 'When is my next SMS meeting?', 'Block Thursday afternoon'] },
  { icon: Mail, color: '#F59E0B', label: 'Emails', examples: ['Show last emails from Paulo', 'Summarize the city hall email', 'Any urgent messages today?'] },
  { icon: Brain, color: '#EF4444', label: 'Memory', examples: ['Save: decision made today', 'What did we agree on SMUL?', 'Summary of last week'] },
  { icon: File, color: '#64748B', label: 'Documents', examples: ['Find the penalty clause in FMS', 'Summarize this PDF', 'What does page 14 say?'] },
]
