...
const caps = [
  { icon: FileText, color: '#7C3AED', label: 'Контракты', examples: ['Какие контракты истекают через 90 дней?', 'Кто ведёт контракт с PGM?', 'Какой наибольший непогашенный остаток?'] },
  { icon: FolderKanban, color: '#0EA5E9', label: 'Проекты', examples: ['Какие проекты просрочены?', 'Создай задачу в Notion', 'Каков статус проекта X?'] },
  { icon: CalendarDays, color: '#25D366', label: 'Календарь', examples: ['Что у меня сегодня?', 'Когда следующая встреча с SMS?', 'Заблокируй четверг после обеда'] },
  { icon: Mail, color: '#F59E0B', label: 'Почта', examples: ['Покажи последние письма от Пауло', 'Резюмируй письмо от мэрии', 'Есть срочные сообщения сегодня?'] },
  { icon: Brain, color: '#EF4444', label: 'Память', examples: ['Сохрани: решение принятое сегодня', 'Что мы договорились по SMUL?', 'Итоги прошлой недели'] },
  { icon: File, color: '#64748B', label: 'Документы', examples: ['Найди штрафную оговорку в FMS', 'Резюмируй этот PDF', 'Что написано на странице 14?'] },
]
      ...
      <motion.div initial={{ opacity: 0, scale: 0.97 }} animate={{ opacity: 1, scale: 1 }}
        ...
        <div className="shrink-0 px-12 pt-10 pb-5">
          ...
          <motion.h2 initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}
            ...
            О чём можно спросить — на обычном языке
          </motion.h2>
        </div>
