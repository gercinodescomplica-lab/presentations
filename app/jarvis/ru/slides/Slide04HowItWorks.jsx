...
const conversations = [
  ...
  {
    label: 'Голос и документы',
    color: '#F59E0B',
    exchanges: [
      { from: 'user', text: '[аудио 2 минуты]', isAudio: true },
      { from: 'jarvis', text: '🎤 Расшифровано и сохранено в памяти.\n"Найди штрафную оговорку в контракте FMS"\n→ Пункт 14.3, стр. 28: "…"' },
    ],
  },
]
      ...
      <motion.div initial={{ opacity: 0, scale: 0.97 }} animate={{ opacity: 1, scale: 1 }}
        ...
        <div className="shrink-0 px-12 pt-10 pb-6">
          ...
          <motion.h2 initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}
            ...
            Просто спросите. На обычном языке. В любом формате.
          </motion.h2>
        </div>
