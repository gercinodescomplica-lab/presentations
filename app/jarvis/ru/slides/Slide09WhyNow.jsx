...
const reasons = [
  { icon: Cpu, color: '#7C3AED', title: 'ИИ достиг переломного момента', desc: 'LLM теперь понимают контекст, вызывают настоящие API и рассуждают над живыми данными — без галлюцинаций при правильной настройке.' },
  { icon: Smartphone, color: '#25D366', title: '98% проникновение WhatsApp в Бразилии', desc: 'Это единственное приложение, которое у всех открыто весь день. Канал уже установлен — нулевой барьер для принятия.' },
  { icon: Zap, color: '#F59E0B', title: 'ИИ + канал + реальные данные = настоящая замена ручного труда', desc: 'Это не FAQ-чатбот. Это ассистент, который по-настоящему заменяет ручную, монотонную и трудоёмкую работу.' },
]
      ...
      <motion.div initial={{ opacity: 0, scale: 0.97 }} animate={{ opacity: 1, scale: 1 }}
        ...
        <div className="text-center relative z-10">
          ...
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.45 }}
            ...
            Три силы выстраиваются в ряд — и окно возможностей открыто.
          </motion.p>
        </div>
        ...
        <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.9 }}
          ...
          Jarvis — создан для тех, кто не может позволить себе терять время.
        </motion.p>
      </motion.div>
    </div>
  )
