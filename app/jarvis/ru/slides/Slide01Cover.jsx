...
const chat = [
  { from: 'user', text: 'Какие контракты истекают в этом месяце?' },
  { from: 'jarvis', text: '2 контракта истекают в апреле:\n• SEGES — R$ 45,1M — срок 30/04\n• SGM — R$ 25,7M — срок 30/04' },
  { from: 'user', text: 'Напомни позвонить в SEGES в пятницу в 9 утра' },
  { from: 'jarvis', text: '⏰ Напоминание создано! Уведомлю вас в пятницу в 09:00.' },
]
      ...
      >
        ...
        <div className="w-1/2 flex flex-col justify-center px-14 lg:px-16 py-14 gap-6 relative z-10">
          ...
          <motion.p initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6, duration: 0.6 }}
            ...
            Исполнительный ассистент, живущий в вашем <strong className="text-slate-700 font-semibold">WhatsApp</strong>.
          </motion.p>
          ...
          <motion.p initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.75 }}
            ...
            Никаких новых приложений. Никаких новых паролей. Никакого обучения.<br />
            Просто отправьте сообщение — или голосовое.
          </motion.p>

          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1 }}
            className="flex items-center gap-3 flex-wrap">
            {[{ icon: Bot, label: 'Claude AI' }, { icon: MessageCircle, label: 'WhatsApp' }, { icon: Zap, label: 'В реальном времени' }].map(({ icon: Icon, label }) => (
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.5, duration: 0.7, ease: [0.22, 1, 0.36, 1] }}
            ...
            <div className="flex items-center gap-3 px-4 py-3" style={{ background: '#075E54' }}>
              ...
              <div>
                ...
                <div className="text-white/60 text-[11px]">онлайн</div>
              </div>
            </div>
