...
const reasons = [
  { icon: Cpu, color: '#7C3AED', title: 'A IA atingiu o ponto de inflexão', desc: 'Os LLMs hoje entendem contexto, chamam APIs reais e raciocinam sobre dados ao vivo — sem alucinação quando corretamente configurados.' },
  { icon: Smartphone, color: '#25D366', title: '98% de penetração do WhatsApp no Brasil', desc: 'É o único app que todo mundo tem aberto o dia inteiro. O canal já está instalado — barreira de adoção zero.' },
  { icon: Zap, color: '#F59E0B', title: 'IA + canal + dados reais = trabalho de verdade substituído', desc: 'Não é um chatbot de FAQ. É um assistente que genuinamente substitui trabalho manual, repetitivo e demorado.' },
]
      ...
      <motion.div initial={{ opacity: 0, scale: 0.97 }} animate={{ opacity: 1, scale: 1 }}
        ...
        <div className="text-center relative z-10">
          ...
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.45 }}
            ...
            Três forças se alinham — e a janela está aberta.
          </motion.p>
        </div>
