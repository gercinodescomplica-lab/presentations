...
const integrations = [
  { icon: MessageCircle, name: 'WhatsApp', sub: 'Evolution API', desc: 'Texto, áudio, PDFs — o canal principal', color: '#25D366' },
  { icon: BookOpen, name: 'Notion', sub: 'Projects API', desc: 'Projetos, tarefas, status e prazos', color: '#000000' },
  { icon: Mail, name: 'Microsoft 365', sub: 'MS Graph', desc: 'Agenda, reuniões e emails', color: '#0078D4' },
  { icon: FileText, name: 'Contratos', sub: 'Sistema Interno', desc: 'Valores, vencimentos, gestores e objetos', color: '#7C3AED' },
  { icon: BarChart3, name: 'Dashboard DRM', sub: 'Comercial', desc: 'Metas, forecast, pipeline e CX', color: '#F59E0B' },
  { icon: File, name: 'Documentos', sub: 'Busca Semântica PDF', desc: 'Conteúdo indexado e pesquisável', color: '#EF4444' },
]
      ...
      <motion.div initial={{ opacity: 0, scale: 0.97 }} animate={{ opacity: 1, scale: 1 }}
        ...
        <div className="w-[35%] flex flex-col justify-center px-12 lg:px-14 py-14 gap-5 border-r border-slate-100 relative z-10">
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.45 }}
            ...
            <span className="text-slate-400 text-sm tracking-wide">6 sistemas, uma conversa</span>
          </motion.div>
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.55 }}
            className="text-slate-500 text-sm leading-relaxed">
            O Jarvis conecta-se diretamente aos seus sistemas críticos — sem copiar e colar, sem consultas manuais. Cada resposta vem de uma fonte viva e oficial.
          </motion.p>
        </div>
