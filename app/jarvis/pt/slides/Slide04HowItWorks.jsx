...
const conversations = [
  ...
  },
  {
    ...
    color: '#25D366',
    exchanges: [
      { from: 'user', text: 'Me lembra de ligar pro SEGES na sexta às 9h' },
      { from: 'jarvis', text: '⏰ Lembrete criado! Te aviso sexta às 09:00.' },
    ],
  },
  {
    label: 'Voz e Documentos',
    color: '#F59E0B',
    exchanges: [
      { from: 'user', text: '[áudio de 2 minutos]', isAudio: true },
      { from: 'jarvis', text: '🎤 Transcrito e salvo na memória.\n"Encontre a cláusula de multa no contrato FMS"\n→ Cláusula 14.3, página 28: "…"' },
    ],
  },
]
      ...
      <motion.div initial={{ opacity: 0, scale: 0.97 }} animate={{ opacity: 1, scale: 1 }}
        ...
        <div className="shrink-0 px-12 pt-10 pb-6">
          ...
          <motion.h2 initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}
            ...
            Pergunte. Em linguagem natural. Em qualquer formato.
          </motion.h2>
        </div>
