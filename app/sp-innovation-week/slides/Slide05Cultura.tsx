...
const dimensions = [
  { icon: Users, label: 'Mudança cultural', desc: 'Mentalidade orientada ao digital e ao cidadão em todos os níveis.' },
  { icon: Shield, label: 'Governança', desc: 'Estruturas de decisão ágeis e responsáveis pela jornada digital.' },
  { icon: GitBranch, label: 'Processos', desc: 'Redesenho dos fluxos para eliminar redundâncias e gargalos.' },
  { icon: TrendingUp, label: 'Eficiência operacional', desc: 'Redução de custos e tempo por meio da automação e integração.' },
  { icon: Heart, label: 'Centralidade no cidadão', desc: 'O cidadão como ponto de partida de toda decisão de design de serviço.' },
]

export default function Slide05Cultura() {
  return (
      ...
      <div className="w-[30%] h-full flex flex-col justify-between p-12 relative border-r border-[#1E3A52]" style={{ backgroundColor: '#0A1120' }}>
        ...
        <div className="relative z-10 flex flex-col gap-6">
          ...
          <div>
            ...
            >
              Mais do que<br />
              <span className="text-[#09DFAB]">tecnologia</span>
            </motion.h2>
            ...
            >
              A transformação digital não é sobre ferramentas. É sobre como o governo entrega valor à sociedade.
            </motion.p>
          </div>
        </div>
        ...
        >
          ...
          <p className="text-white text-base leading-snug font-medium italic">
            "Transformação digital é transformar a forma como o serviço público entrega valor."
          </p>
        </motion.div>
      </div>
