...
export default function Slide06bTriade() {
  return (
    <div className="w-full h-full bg-[#0F172A] text-white overflow-hidden relative">
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}
        ...
        <span className="font-mono text-[10px] uppercase tracking-widest text-[#09DFAB]">
          Bloco 3 · Interoperabilidade · Tríade Digital SP
        </span>
      </motion.div>
      ...
      {/* Layout: [left callout] [pyramid] [right callouts] */}
      <div className="absolute inset-0 flex items-center justify-center px-4 pt-12 pb-10">

        {/* LEFT — SuperApp / Smart 156 */}
        <motion.div
        ...
        >
          ...
          <p className="text-[#8BA0B4] text-base text-right leading-relaxed">
        ...
        >
          ...
          >
            ...
            {/* Smart 156 — top-left */}
            <polygon points="250,15 123,228 250,228" fill="url(#spw-sl)" />
            {/* Digital Twin — top-right */}
            <polygon points="250,15 250,228 377,228" fill="url(#spw-sr)" />
            {/* Data Lake — bottom trapezoid */}
            <polygon points="123,228 377,228 470,385 30,385" fill="url(#spw-b)" />

            {/* Outer border */}
            <polygon points="250,15 30,385 470,385"
              fill="none" stroke="rgba(9,223,171,0.65)" strokeWidth="2" filter="url(#spw-glow)" />
        ...
        <div className="w-[21%] flex-shrink-0 flex flex-col justify-center gap-8 pl-4">
          ...
          >
            ...
            <p className="text-[#8BA0B4] text-base leading-relaxed">
              Representação virtual da cidade em tempo real — sensoriamento, infraestrutura e mobilidade integrados.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-[#8BA0B4] text-base leading-relaxed">
              Centralização e governança dos dados de Saúde, SPTrans, Educação e demais secretarias municipais.
            </p>
          </motion.div>
