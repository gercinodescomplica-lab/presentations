...
export default function Slide15Fechamento() {
  return (
    <div className="w-full h-full flex bg-[#0F172A] text-white overflow-hidden">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          >
            A tecnologia só faz sentido quando aproxima<br />
            governo e sociedade.
          </motion.p>
        </div>
      ...
      <div className="flex-1 h-full relative flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          <div className="relative w-64 h-64 flex items-center justify-center">
            <div className="absolute w-72 h-72 rounded-full bg-[#04767F] blur-[100px] opacity-20 pointer-events-none" />
          ...
          >
            <p className="text-2xl font-bold leading-snug mb-3" style={{ textShadow: '0 0 20px rgba(9,223,171,0.15)' }}>
              "Transformar digitalmente o setor público
            </p>
            <p className="text-2xl font-bold leading-snug text-[#09DFAB]">
              é transformar a experiência do cidadão."
            </p>
          </motion.div>

          {/* SP Innovation Week badge */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
