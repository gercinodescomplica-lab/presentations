...
const points = [
  { icon: ShoppingBag, label: 'Marketplace de soluções públicas', desc: 'Catálogo curado de produtos e serviços tecnológicos para o setor público.' },
  { icon: Cpu, label: 'Curadoria tecnológica', desc: 'Análise técnica e homologação das soluções disponíveis no portfólio.' },
  { icon: Link2, label: 'Conexão governo–parceiros', desc: 'Ponte entre a Prefeitura, startups, big techs e integradores especializados.' },
  { icon: Zap, label: 'Agilidade na adoção', desc: 'Processo acelerado de contratação e implantação de novas tecnologias.' },
  { icon: TrendingUp, label: 'Escalabilidade', desc: 'Soluções prontas para crescer junto com as demandas da cidade.' },
]

export default function Slide09ProdamStore() {
  return (
      ...
      <div className="w-[30%] h-full flex flex-col justify-between p-12 relative border-r border-[#1E3A52]" style={{ backgroundColor: '#0A1120' }}>
        ...
        <div className="relative z-10 flex flex-col gap-6">
          ...
          <div>
            ...
            >
              O papel da<br />
              <span className="text-[#09DFAB]">Prodam Store</span>
            </motion.h2>
            <motion.p initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25 }} className="text-[#8BA0B4] text-sm leading-relaxed">
              A plataforma que conecta inovação tecnológica à gestão pública municipal.
            </motion.p>
          </div>
        </div>
        ...
        >
          ...
          <p className="text-white text-sm leading-snug font-medium italic">
            "A inovação pública precisa ser acessível, integrada e escalável."
          </p>
        </motion.div>
      </div>
            ...
            return (
              <motion.div
                ...
                style={{
                  ...
                  borderLeft: '3px solid rgba(9,223,171,0.5)',
                }}
              >
                <div className="p-2.5 rounded-xl flex-shrink-0" style={{ background: 'rgba(9,223,171,0.08)', border: '1px solid rgba(9,223,171,0.18)' }}>
