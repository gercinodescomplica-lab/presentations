...
export default function Slide01Capa() {
  return (
    <div className="w-full h-full flex bg-[#0F172A] text-white overflow-hidden">
      ...
      {/* PAINEL ESQUERDO */}
      <div
        className="w-[32%] h-full flex flex-col justify-between p-12 relative border-r border-[#1E3A52]"
      ...
      >
        ...
        >
          ...
          <span className="text-[#8BA0B4] font-semibold tracking-wider uppercase text-sm leading-tight">
            PRODAM · SP INNOVATION WEEK
          </span>
        </motion.div>
        ...
        <div className="relative z-10 mb-16">
          ...
          >
            Transformação<br />
            <span className="text-[#09DFAB]">Digital</span> &amp;<br />
            Integração
          </motion.h1>
          ...
          >
            Digitalização, interoperabilidade e novos modelos de gestão pública.
          </motion.p>
        </div>
        ...
        <motion.div
          ...
          className="relative z-10 text-[#4A6580] font-mono text-xs tracking-widest uppercase"
        >
          PRODAM · 2026
        </motion.div>
      </div>
      ...
      <div className="flex-1 h-full relative flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          <div className="relative w-72 h-72 flex items-center justify-center">
            ...
            <div className="absolute inset-14 rounded-full" style={{ background: 'radial-gradient(circle, rgba(9,223,171,0.06) 0%, rgba(4,118,127,0.03) 60%, transparent 100%)', border: '1px solid rgba(9,223,171,0.12)', boxShadow: '0 0 40px rgba(9,223,171,0.12), inset 0 0 30px rgba(4,118,127,0.08)' }} />
          ...
          <div className="flex items-center gap-4">
            {['Digitalização', 'Interoperabilidade', 'IA Pública'].map((tag, i) => (
              <motion.div
                key={tag}
                initial={{ opacity: 0, y: 12 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 1.2 + i * 0.1 }}
                className="px-3 py-1.5 rounded-full font-mono text-[11px] tracking-widest uppercase"
                style={{ border: '1px solid rgba(9,223,171,0.25)', background: 'rgba(9,223,171,0.05)', color: '#09DFAB' }}
              >
                {tag}
              </motion.div>
            ))}
