...
export default function Slide03SmartCities() {
  ...
  const blocks = t('slide03.blocks', { returnObjects: true }).map((b, i) => ({
    ...b,
    color: COLORS[i % COLORS.length],
  }))
  const stat1 = t('slide03.stat1', { returnObjects: true })
  const stat2 = t('slide03.stat2', { returnObjects: true })

  return (
    <SlideCard slideNum="03" label={t('slide03.label')}>
      <div className="flex h-full">
        <LeftPanel>
          ...
          >
            <TagLabel>{t('slide03.tag')}</TagLabel>
          </motion.div>
          ...
          >
            <SubtitleBar>{t('slide03.subtitle')}</SubtitleBar>
          </motion.div>
